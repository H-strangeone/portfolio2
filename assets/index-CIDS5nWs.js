...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:tr,depthTest:!1,depthWrite:!1})}function JS(r,e,t){const n=new Float32Array(qr),i=new W(0,1,0);return new zi({name:"SphericalGaussianBlur",defines:{n:qr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Cl(),fragmentShader:`
		...
		`,blending:tr,depthTest:!1,depthWrite:!1})}function ed(){return new zi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Cl(),fragmentShader:`
		...
		`,blending:tr,depthTest:!1,depthWrite:!1})}function td(){return new zi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Cl(),fragmentShader:`
...
`)}const iy={[Jp]:"Linear",[Qp]:"Reinhard",[em]:"Cineon",[tm]:"ACESFilmic",[im]:"AgX",[rm]:"Neutral",[nm]:"Custom"};function ry(r,e){const t=iy[e];return t===void 0?(Ye("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Wo=new W;function sy(){ct.getLuminanceCoefficients(Wo);const r=Wo.x.toFixed(4),e=Wo.y.toFixed(4),t=Wo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(Ca).join(`
`)),a=Wu(a),a=hd(a,t),a=fd(a,t),o=Wu(o),o=hd(o,t),o=fd(o,t),a=dd(a),o=dd(o),t.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+p);const b=E+m+a,M=E+p+o,T=ld(i,i.VERTEX_SHADER,b),A=ld(i,i.FRAGMENT_SHADER,M);i.attachShader(_,T),i.attachShader(_,A),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function w(C){if(r.debug.checkShaderErrors){const D=i.getProgramInfoLog(_)||"",O=i.getShaderInfoLog(T)||"",V=i.getShaderInfoLog(A)||"",G=D.trim(),z=O.trim(),N=V.trim();let Y=!0,ee=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Y=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,T,A);else{const P=ud(i,T,"vertex"),re=ud(i,A,"fragment");lt("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
Program Info Log: `+G+`
`+P+`
`+re)}else G!==""?Ye("WebGLProgram: Program Info Log:",G):(z===""||N==="")&&(ee=!1);ee&&(C.diagnostics={runnable:Y,programLog:G,vertexShader:{log:z,prefix:m},fragmentShader:{log:N,prefix:p}})}i.deleteShader(T),i.deleteShader(A),L=new sl(i,_),x=ly(i,_)}let L;this.getUniforms=function(){return L===void 0&&w(this),L};let x;this.getAttributes=function(){return x===void 0&&w(this),x};let S=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return S===!1&&(S=i.getProgramParameter(_,JM)),S},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(_),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=QM++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=T,this.fragmentShader=A,this}let Ty=0;class by{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,i=this._getShaderStage(t),s=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(i)===!1&&(a.add(i),i.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new wy(e),t.set(e,n)),n}}class wy{constructor(e){this.id=Ty++,this.code=e,this.usedTimes=0}}function Ay(r,e,t,n,i,s,a){const o=new Ch,l=new by,c=new Set,u=[],h=new Map,d=i.logarithmicDepthBuffer;let f=i.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(x){return c.add(x),x===0?"uv":`uv${x}`}function m(x,S,C,D,O){const V=D.fog,G=O.geometry,z=x.isMeshStandardMaterial?D.environment:null,N=(x.isMeshStandardMaterial?t:e).get(x.envMap||z),Y=N&&N.mapping===Rl?N.image.height:null,ee=g[x.type];x.precision!==null&&(f=i.getMaxPrecision(x.precision),f!==x.precision&&Ye("WebGLProgram.getParameters:",x.precision,"not supported, using",f,"instead."));const P=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,re=P!==void 0?P.length:0;let Le=0;G.morphAttributes.position!==void 0&&(Le=1),G.morphAttributes.normal!==void 0&&(Le=2),G.morphAttributes.color!==void 0&&(Le=3);let Oe,He,qe,K;if(ee){const _e=wi[ee];Oe=_e.vertexShader,He=_e.fragmentShader}else Oe=x.vertexShader,He=x.fragmentShader,l.update(x),qe=l.getVertexShaderID(x),K=l.getFragmentShaderID(x);const J=r.getRenderTarget(),fe=r.state.buffers.depth.getReversed(),Ce=O.isInstancedMesh===!0,Se=O.isBatchedMesh===!0,ke=!!x.map,ot=!!x.matcap,Te=!!N,Be=!!x.aoMap,Ke=!!x.lightMap,Ue=!!x.bumpMap,H=!!x.normalMap,U=!!x.displacementMap,mt=!!x.emissiveMap,Qe=!!x.metalnessMap,ze=!!x.roughnessMap,Me=x.anisotropy>0,R=x.clearcoat>0,v=x.dispersion>0,F=x.iridescence>0,Z=x.sheen>0,j=x.transmission>0,$=Me&&!!x.anisotropyMap,ve=R&&!!x.clearcoatMap,se=R&&!!x.clearcoatNormalMap,be=R&&!!x.clearcoatRoughnessMap,Ee=F&&!!x.iridescenceMap,ie=F&&!!x.iridescenceThicknessMap,ae=Z&&!!x.sheenColorMap,ye=Z&&!!x.sheenRoughnessMap,we=!!x.specularMap,oe=!!x.specularColorMap,Ge=!!x.specularIntensityMap,I=j&&!!x.transmissionMap,ue=j&&!!x.thicknessMap,ne=!!x.gradientMap,he=!!x.alphaMap,te=x.alphaTest>0,Q=!!x.alphaHash,ce=!!x.extensions;let Ie=Ii;x.toneMapped&&(J===null||J.isXRRenderTarget===!0)&&(Ie=r.toneMapping);const ht={shaderID:ee,shaderType:x.type,shaderName:x.name,vertexShader:Oe,fragmentShader:He,defines:x.defines,customVertexShaderID:qe,customFragmentShaderID:K,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:f,batching:Se,batchingColor:Se&&O._colorsTexture!==null,instancing:Ce,instancingColor:Ce&&O.instanceColor!==null,instancingMorph:Ce&&O.morphTexture!==null,outputColorSpace:J===null?r.outputColorSpace:J.isXRRenderTarget===!0?J.texture.colorSpace:na,alphaToCoverage:!!x.alphaToCoverage,map:ke,matcap:ot,envMap:Te,envMapMode:Te&&N.mapping,envMapCubeUVHeight:Y,aoMap:Be,lightMap:Ke,bumpMap:Ue,normalMap:H,displacementMap:U,emissiveMap:mt,normalMapObjectSpace:H&&x.normalMapType===Xg,normalMapTangentSpace:H&&x.normalMapType===dm,metalnessMap:Qe,roughnessMap:ze,anisotropy:Me,anisotropyMap:$,clearcoat:R,clearcoatMap:ve,clearcoatNormalMap:se,clearcoatRoughnessMap:be,dispersion:v,iridescence:F,iridescenceMap:Ee,iridescenceThicknessMap:ie,sheen:Z,sheenColorMap:ae,sheenRoughnessMap:ye,specularMap:we,specularColorMap:oe,specularIntensityMap:Ge,transmission:j,transmissionMap:I,thicknessMap:ue,gradientMap:ne,opaque:x.transparent===!1&&x.blending===Ws&&x.alphaToCoverage===!1,alphaMap:he,alphaTest:te,alphaHash:Q,combine:x.combine,mapUv:ke&&_(x.map.channel),aoMapUv:Be&&_(x.aoMap.channel),lightMapUv:Ke&&_(x.lightMap.channel),bumpMapUv:Ue&&_(x.bumpMap.channel),normalMapUv:H&&_(x.normalMap.channel),displacementMapUv:U&&_(x.displacementMap.channel),emissiveMapUv:mt&&_(x.emissiveMap.channel),metalnessMapUv:Qe&&_(x.metalnessMap.channel),roughnessMapUv:ze&&_(x.roughnessMap.channel),anisotropyMapUv:$&&_(x.anisotropyMap.channel),clearcoatMapUv:ve&&_(x.clearcoatMap.channel),clearcoatNormalMapUv:se&&_(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:be&&_(x.clearcoatRoughnessMap.channel),iridescenceMapUv:Ee&&_(x.iridescenceMap.channel),iridescenceThicknessMapUv:ie&&_(x.iridescenceThicknessMap.channel),sheenColorMapUv:ae&&_(x.sheenColorMap.channel),sheenRoughnessMapUv:ye&&_(x.sheenRoughnessMap.channel),specularMapUv:we&&_(x.specularMap.channel),specularColorMapUv:oe&&_(x.specularColorMap.channel),specularIntensityMapUv:Ge&&_(x.specularIntensityMap.channel),transmissionMapUv:I&&_(x.transmissionMap.channel),thicknessMapUv:ue&&_(x.thicknessMap.channel),alphaMapUv:he&&_(x.alphaMap.channel),vertexTangents:!!G.attributes.tangent&&(H||Me),vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,pointsUvs:O.isPoints===!0&&!!G.attributes.uv&&(ke||he),fog:!!V,useFog:x.fog===!0,fogExp2:!!V&&V.isFogExp2,flatShading:x.flatShading===!0&&x.wireframe===!1,sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:fe,skinning:O.isSkinnedMesh===!0,morphTargets:G.morphAttributes.position!==void 0,morphNormals:G.morphAttributes.normal!==void 0,morphColors:G.morphAttributes.color!==void 0,morphTargetsCount:re,morphTextureStride:Le,numDirLights:S.directional.length,numPointLights:S.point.length,numSpotLights:S.spot.length,numSpotLightMaps:S.spotLightMap.length,numRectAreaLights:S.rectArea.length,numHemiLights:S.hemi.length,numDirLightShadows:S.directionalShadowMap.length,numPointLightShadows:S.pointShadowMap.length,numSpotLightShadows:S.spotShadowMap.length,numSpotLightShadowsWithMaps:S.numSpotLightShadowsWithMaps,numLightProbes:S.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:x.dithering,shadowMapEnabled:r.shadowMap.enabled&&C.length>0,shadowMapType:r.shadowMap.type,toneMapping:Ie,decodeVideoTexture:ke&&x.map.isVideoTexture===!0&&ct.getTransfer(x.map.colorSpace)===vt,decodeVideoTextureEmissive:mt&&x.emissiveMap.isVideoTexture===!0&&ct.getTransfer(x.emissiveMap.colorSpace)===vt,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===Zi,flipSided:x.side===Bn,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:ce&&x.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ce&&x.extensions.multiDraw===!0||Se)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return ht.vertexUv1s=c.has(1),ht.vertexUv2s=c.has(2),ht.vertexUv3s=c.has(3),c.clear(),ht}function p(x){const S=[];if(x.shaderID?S.push(x.shaderID):(S.push(x.customVertexShaderID),S.push(x.customFragmentShaderID)),x.defines!==void 0)for(const C in x.defines)S.push(C),S.push(x.defines[C]);return x.isRawShaderMaterial===!1&&(E(S,x),b(S,x),S.push(r.outputColorSpace)),S.push(x.customProgramCacheKey),S.join()}function E(x,S){x.push(S.precision),x.push(S.outputColorSpace),x.push(S.envMapMode),x.push(S.envMapCubeUVHeight),x.push(S.mapUv),x.push(S.alphaMapUv),x.push(S.lightMapUv),x.push(S.aoMapUv),x.push(S.bumpMapUv),x.push(S.normalMapUv),x.push(S.displacementMapUv),x.push(S.emissiveMapUv),x.push(S.metalnessMapUv),x.push(S.roughnessMapUv),x.push(S.anisotropyMapUv),x.push(S.clearcoatMapUv),x.push(S.clearcoatNormalMapUv),x.push(S.clearcoatRoughnessMapUv),x.push(S.iridescenceMapUv),x.push(S.iridescenceThicknessMapUv),x.push(S.sheenColorMapUv),x.push(S.sheenRoughnessMapUv),x.push(S.specularMapUv),x.push(S.specularColorMapUv),x.push(S.specularIntensityMapUv),x.push(S.transmissionMapUv),x.push(S.thicknessMapUv),x.push(S.combine),x.push(S.fogExp2),x.push(S.sizeAttenuation),x.push(S.morphTargetsCount),x.push(S.morphAttributeCount),x.push(S.numDirLights),x.push(S.numPointLights),x.push(S.numSpotLights),x.push(S.numSpotLightMaps),x.push(S.numHemiLights),x.push(S.numRectAreaLights),x.push(S.numDirLightShadows),x.push(S.numPointLightShadows),x.push(S.numSpotLightShadows),x.push(S.numSpotLightShadowsWithMaps),x.push(S.numLightProbes),x.push(S.shadowMapType),x.push(S.toneMapping),x.push(S.numClippingPlanes),x.push(S.numClipIntersection),x.push(S.depthPacking)}function b(x,S){o.disableAll(),S.instancing&&o.enable(0),S.instancingColor&&o.enable(1),S.instancingMorph&&o.enable(2),S.matcap&&o.enable(3),S.envMap&&o.enable(4),S.normalMapObjectSpace&&o.enable(5),S.normalMapTangentSpace&&o.enable(6),S.clearcoat&&o.enable(7),S.iridescence&&o.enable(8),S.alphaTest&&o.enable(9),S.vertexColors&&o.enable(10),S.vertexAlphas&&o.enable(11),S.vertexUv1s&&o.enable(12),S.vertexUv2s&&o.enable(13),S.vertexUv3s&&o.enable(14),S.vertexTangents&&o.enable(15),S.anisotropy&&o.enable(16),S.alphaHash&&o.enable(17),S.batching&&o.enable(18),S.dispersion&&o.enable(19),S.batchingColor&&o.enable(20),S.gradientMap&&o.enable(21),x.push(o.mask),o.disableAll(),S.fog&&o.enable(0),S.useFog&&o.enable(1),S.flatShading&&o.enable(2),S.logarithmicDepthBuffer&&o.enable(3),S.reversedDepthBuffer&&o.enable(4),S.skinning&&o.enable(5),S.morphTargets&&o.enable(6),S.morphNormals&&o.enable(7),S.morphColors&&o.enable(8),S.premultipliedAlpha&&o.enable(9),S.shadowMapEnabled&&o.enable(10),S.doubleSided&&o.enable(11),S.flipSided&&o.enable(12),S.useDepthPacking&&o.enable(13),S.dithering&&o.enable(14),S.transmission&&o.enable(15),S.sheen&&o.enable(16),S.opaque&&o.enable(17),S.pointsUvs&&o.enable(18),S.decodeVideoTexture&&o.enable(19),S.decodeVideoTextureEmissive&&o.enable(20),S.alphaToCoverage&&o.enable(21),x.push(o.mask)}function M(x){const S=g[x.type];let C;if(S){const D=wi[S];C=U0.clone(D.uniforms)}else C=x.uniforms;return C}function T(x,S){let C=h.get(S);return C!==void 0?++C.usedTimes:(C=new Ey(r,S,x,s),u.push(C),h.set(S,C)),C}function A(x){if(--x.usedTimes===0){const S=u.indexOf(x);u[S]=u[u.length-1],u.pop(),h.delete(x.cacheKey),x.destroy()}}function w(x){l.remove(x)}function L(){l.dispose()}return{getParameters:m,getProgramCacheKey:p,getUniforms:M,acquireProgram:T,releaseProgram:A,releaseShaderCache:w,programs:u,dispose:L}}function Ry(){let r=new WeakMap;function e(a){return r.has(a)}function t(a){let o=r.get(a);return o===void 0&&(o={},r.set(a,o)),o}function n(a){r.delete(a)}function i(a,o,l){r.get(a)[o]=l}function s(){r=new WeakMap}return{has:e,get:t,remove:n,update:i,dispose:s}}function Cy(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.material.id!==e.material.id?r.material.id-e.material.id:r.z!==e.z?r.z-e.z:r.id-e.id}function md(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.z!==e.z?e.z-r.z:r.id-e.id}function _d(){const r=[];let e=0;const t=[],n=[],i=[];function s(){e=0,t.length=0,n.length=0,i.length=0}function a(h,d,f,g,_,m){let p=r[e];return p===void 0?(p={id:h.id,object:h,geometry:d,material:f,groupOrder:g,renderOrder:h.renderOrder,z:_,group:m},r[e]=p):(p.id=h.id,p.object=h,p.geometry=d,p.material=f,p.groupOrder=g,p.renderOrder=h.renderOrder,p.z=_,p.group=m),e++,p}function o(h,d,f,g,_,m){const p=a(h,d,f,g,_,m);f.transmission>0?n.push(p):f.transparent===!0?i.push(p):t.push(p)}function l(h,d,f,g,_,m){const p=a(h,d,f,g,_,m);f.transmission>0?n.unshift(p):f.transparent===!0?i.unshift(p):t.unshift(p)}function c(h,d){t.length>1&&t.sort(h||Cy),n.length>1&&n.sort(d||md),i.length>1&&i.sort(d||md)}function u(){for(let h=e,d=r.length;h<d;h++){const f=r[h];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:t,transmissive:n,transparent:i,init:s,push:o,unshift:l,finish:u,sort:c}}function Py(){let r=new WeakMap;function e(n,i){const s=r.get(n);let a;return s===void 0?(a=new _d,r.set(n,[a])):i>=s.length?(a=new _d,s.push(a)):a=s[i],a}function t(){r=new WeakMap}return{get:e,dispose:t}}function Dy(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new W,color:new pt};break;case"SpotLight":t={position:new W,direction:new W,color:new pt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new W,color:new pt,distance:0,decay:0};break;case"HemisphereLight":t={direction:new W,skyColor:new pt,groundColor:new pt};break;case"RectAreaLight":t={color:new pt,position:new W,halfWidth:new W,halfHeight:new W};break}return r[e.id]=t,t}}}function Ly(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ut};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ut};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ut,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[e.id]=t,t}}}let Iy=0;function Uy(r,e){return(e.castShadow?2:0)-(r.castShadow?2:0)+(e.map?1:0)-(r.map?1:0)}function Ny(r){const e=new Dy,t=Ly(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new W);const i=new W,s=new It,a=new It;function o(c){let u=0,h=0,d=0;for(let x=0;x<9;x++)n.probe[x].set(0,0,0);let f=0,g=0,_=0,m=0,p=0,E=0,b=0,M=0,T=0,A=0,w=0;c.sort(Uy);for(let x=0,S=c.length;x<S;x++){const C=c[x],D=C.color,O=C.intensity,V=C.distance;let G=null;if(C.shadow&&C.shadow.map&&(C.shadow.map.texture.format===ta?G=C.shadow.map.texture:G=C.shadow.map.depthTexture||C.shadow.map.texture),C.isAmbientLight)u+=D.r*O,h+=D.g*O,d+=D.b*O;else if(C.isLightProbe){for(let z=0;z<9;z++)n.probe[z].addScaledVector(C.sh.coefficients[z],O);w++}else if(C.isDirectionalLight){const z=e.get(C);if(z.color.copy(C.color).multiplyScalar(C.intensity),C.castShadow){const N=C.shadow,Y=t.get(C);Y.shadowIntensity=N.intensity,Y.shadowBias=N.bias,Y.shadowNormalBias=N.normalBias,Y.shadowRadius=N.radius,Y.shadowMapSize=N.mapSize,n.directionalShadow[f]=Y,n.directionalShadowMap[f]=G,n.directionalShadowMatrix[f]=C.shadow.matrix,E++}n.directional[f]=z,f++}else if(C.isSpotLight){const z=e.get(C);z.position.setFromMatrixPosition(C.matrixWorld),z.color.copy(D).multiplyScalar(O),z.distance=V,z.coneCos=Math.cos(C.angle),z.penumbraCos=Math.cos(C.angle*(1-C.penumbra)),z.decay=C.decay,n.spot[_]=z;const N=C.shadow;if(C.map&&(n.spotLightMap[T]=C.map,T++,N.updateMatrices(C),C.castShadow&&A++),n.spotLightMatrix[_]=N.matrix,C.castShadow){const Y=t.get(C);Y.shadowIntensity=N.intensity,Y.shadowBias=N.bias,Y.shadowNormalBias=N.normalBias,Y.shadowRadius=N.radius,Y.shadowMapSize=N.mapSize,n.spotShadow[_]=Y,n.spotShadowMap[_]=G,M++}_++}else if(C.isRectAreaLight){const z=e.get(C);z.color.copy(D).multiplyScalar(O),z.halfWidth.set(C.width*.5,0,0),z.halfHeight.set(0,C.height*.5,0),n.rectArea[m]=z,m++}else if(C.isPointLight){const z=e.get(C);if(z.color.copy(C.color).multiplyScalar(C.intensity),z.distance=C.distance,z.decay=C.decay,C.castShadow){const N=C.shadow,Y=t.get(C);Y.shadowIntensity=N.intensity,Y.shadowBias=N.bias,Y.shadowNormalBias=N.normalBias,Y.shadowRadius=N.radius,Y.shadowMapSize=N.mapSize,Y.shadowCameraNear=N.camera.near,Y.shadowCameraFar=N.camera.far,n.pointShadow[g]=Y,n.pointShadowMap[g]=G,n.pointShadowMatrix[g]=C.shadow.matrix,b++}n.point[g]=z,g++}else if(C.isHemisphereLight){const z=e.get(C);z.skyColor.copy(C.color).multiplyScalar(O),z.groundColor.copy(C.groundColor).multiplyScalar(O),n.hemi[p]=z,p++}}m>0&&(r.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=me.LTC_FLOAT_1,n.rectAreaLTC2=me.LTC_FLOAT_2):(n.rectAreaLTC1=me.LTC_HALF_1,n.rectAreaLTC2=me.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=h,n.ambient[2]=d;const L=n.hash;(L.directionalLength!==f||L.pointLength!==g||L.spotLength!==_||L.rectAreaLength!==m||L.hemiLength!==p||L.numDirectionalShadows!==E||L.numPointShadows!==b||L.numSpotShadows!==M||L.numSpotMaps!==T||L.numLightProbes!==w)&&(n.directional.length=f,n.spot.length=_,n.rectArea.length=m,n.point.length=g,n.hemi.length=p,n.directionalShadow.length=E,n.directionalShadowMap.length=E,n.pointShadow.length=b,n.pointShadowMap.length=b,n.spotShadow.length=M,n.spotShadowMap.length=M,n.directionalShadowMatrix.length=E,n.pointShadowMatrix.length=b,n.spotLightMatrix.length=M+T-A,n.spotLightMap.length=T,n.numSpotLightShadowsWithMaps=A,n.numLightProbes=w,L.directionalLength=f,L.pointLength=g,L.spotLength=_,L.rectAreaLength=m,L.hemiLength=p,L.numDirectionalShadows=E,L.numPointShadows=b,L.numSpotShadows=M,L.numSpotMaps=T,L.numLightProbes=w,n.version=Iy++)}function l(c,u){let h=0,d=0,f=0,g=0,_=0;const m=u.matrixWorldInverse;for(let p=0,E=c.length;p<E;p++){const b=c[p];if(b.isDirectionalLight){const M=n.directional[h];M.direction.setFromMatrixPosition(b.matrixWorld),i.setFromMatrixPosition(b.target.matrixWorld),M.direction.sub(i),M.direction.transformDirection(m),h++}else if(b.isSpotLight){const M=n.spot[f];M.position.setFromMatrixPosition(b.matrixWorld),M.position.applyMatrix4(m),M.direction.setFromMatrixPosition(b.matrixWorld),i.setFromMatrixPosition(b.target.matrixWorld),M.direction.sub(i),M.direction.transformDirection(m),f++}else if(b.isRectAreaLight){const M=n.rectArea[g];M.position.setFromMatrixPosition(b.matrixWorld),M.position.applyMatrix4(m),a.identity(),s.copy(b.matrixWorld),s.premultiply(m),a.extractRotation(s),M.halfWidth.set(b.width*.5,0,0),M.halfHeight.set(0,b.height*.5,0),M.halfWidth.applyMatrix4(a),M.halfHeight.applyMatrix4(a),g++}else if(b.isPointLight){const M=n.point[d];M.position.setFromMatrixPosition(b.matrixWorld),M.position.applyMatrix4(m),d++}else if(b.isHemisphereLight){const M=n.hemi[_];M.direction.setFromMatrixPosition(b.matrixWorld),M.direction.transformDirection(m),_++}}}return{setup:o,setupView:l,state:n}}function gd(r){const e=new Ny(r),t=[],n=[];function i(u){c.camera=u,t.length=0,n.length=0}function s(u){t.push(u)}function a(u){n.push(u)}function o(){e.setup(t)}function l(u){e.setupView(t,u)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:i,state:c,setupLights:o,setupLightsView:l,pushLight:s,pushShadow:a}}function Fy(r){let e=new WeakMap;function t(i,s=0){const a=e.get(i);let o;return a===void 0?(o=new gd(r),e.set(i,[o])):s>=a.length?(o=new gd(r),a.push(o)):o=a[s],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const Oy=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,zy=[new W(1,0,0),new W(-1,0,0),new W(0,1,0),new W(0,-1,0),new W(0,0,1),new W(0,0,-1)],ky=[new W(0,-1,0),new W(0,-1,0),new W(0,0,1),new W(0,0,-1),new W(0,-1,0),new W(0,-1,0)],xd=new It,xa=new W,Tc=new W;function Vy(r,e,t){let n=new Ph;const i=new ut,s=new ut,a=new Ft,o=new $0,l=new K0,c={},u=t.maxTextureSize,h={[Pr]:Bn,[Bn]:Pr,[Zi]:Zi},d=new zi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ut},radius:{value:4}},vertexShader:Oy,fragmentShader:By}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new lr;g.setAttribute("position",new Ni(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new si(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=el;let p=this.type;this.render=function(A,w,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;A.type===yg&&(Ye("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),A.type=el);const x=r.getRenderTarget(),S=r.getActiveCubeFace(),C=r.getActiveMipmapLevel(),D=r.state;D.setBlending(tr),D.buffers.depth.getReversed()===!0?D.buffers.color.setClear(0,0,0,0):D.buffers.color.setClear(1,1,1,1),D.buffers.depth.setTest(!0),D.setScissorTest(!1);const O=p!==this.type;O&&w.traverse(function(V){V.material&&(Array.isArray(V.material)?V.material.forEach(G=>G.needsUpdate=!0):V.material.needsUpdate=!0)});for(let V=0,G=A.length;V<G;V++){const z=A[V],N=z.shadow;if(N===void 0){Ye("WebGLShadowMap:",z,"has no shadow.");continue}if(N.autoUpdate===!1&&N.needsUpdate===!1)continue;i.copy(N.mapSize);const Y=N.getFrameExtents();if(i.multiply(Y),s.copy(N.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(s.x=Math.floor(u/Y.x),i.x=s.x*Y.x,N.mapSize.x=s.x),i.y>u&&(s.y=Math.floor(u/Y.y),i.y=s.y*Y.y,N.mapSize.y=s.y)),N.map===null||O===!0){if(N.map!==null&&(N.map.depthTexture!==null&&(N.map.depthTexture.dispose(),N.map.depthTexture=null),N.map.dispose()),this.type===Aa){if(z.isPointLight){Ye("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}N.map=new Ui(i.x,i.y,{format:ta,type:ar,minFilter:gn,magFilter:gn,generateMipmaps:!1}),N.map.texture.name=z.name+".shadowMap",N.map.depthTexture=new so(i.x,i.y,Pi),N.map.depthTexture.name=z.name+".shadowMapDepth",N.map.depthTexture.format=or,N.map.depthTexture.compareFunction=null,N.map.depthTexture.minFilter=on,N.map.depthTexture.magFilter=on}else{z.isPointLight?(N.map=new Em(i.x),N.map.depthTexture=new X0(i.x,Oi)):(N.map=new Ui(i.x,i.y),N.map.depthTexture=new so(i.x,i.y,Oi)),N.map.depthTexture.name=z.name+".shadowMap",N.map.depthTexture.format=or;const P=r.state.buffers.depth.getReversed();this.type===el?(N.map.depthTexture.compareFunction=P?bh:Th,N.map.depthTexture.minFilter=gn,N.map.depthTexture.magFilter=gn):(N.map.depthTexture.compareFunction=null,N.map.depthTexture.minFilter=on,N.map.depthTexture.magFilter=on)}N.camera.updateProjectionMatrix()}const ee=N.map.isWebGLCubeRenderTarget?6:1;for(let P=0;P<ee;P++){if(N.map.isWebGLCubeRenderTarget)r.setRenderTarget(N.map,P),r.clear();else{P===0&&(r.setRenderTarget(N.map),r.clear());const re=N.getViewport(P);a.set(s.x*re.x,s.y*re.y,s.x*re.z,s.y*re.w),D.viewport(a)}if(z.isPointLight){const re=N.camera,Le=N.matrix,Oe=z.distance||re.far;Oe!==re.far&&(re.far=Oe,re.updateProjectionMatrix()),xa.setFromMatrixPosition(z.matrixWorld),re.position.copy(xa),Tc.copy(re.position),Tc.add(zy[P]),re.up.copy(ky[P]),re.lookAt(Tc),re.updateMatrixWorld(),Le.makeTranslation(-xa.x,-xa.y,-xa.z),xd.multiplyMatrices(re.projectionMatrix,re.matrixWorldInverse),N._frustum.setFromProjectionMatrix(xd,re.coordinateSystem,re.reversedDepth)}else N.updateMatrices(z);n=N.getFrustum(),M(w,L,N.camera,z,this.type)}N.isPointLightShadow!==!0&&this.type===Aa&&E(N,L),N.needsUpdate=!1}p=this.type,m.needsUpdate=!1,r.setRenderTarget(x,S,C)};function E(A,w){const L=e.update(_);d.defines.VSM_SAMPLES!==A.blurSamples&&(d.defines.VSM_SAMPLES=A.blurSamples,f.defines.VSM_SAMPLES=A.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Ui(i.x,i.y,{format:ta,type:ar})),d.uniforms.shadow_pass.value=A.map.depthTexture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,r.setRenderTarget(A.mapPass),r.clear(),r.renderBufferDirect(w,null,L,d,_,null),f.uniforms.shadow_pass.value=A.mapPass.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,r.setRenderTarget(A.map),r.clear(),r.renderBufferDirect(w,null,L,f,_,null)}function b(A,w,L,x){let S=null;const C=L.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(C!==void 0)S=C;else if(S=L.isPointLight===!0?l:o,r.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const D=S.uuid,O=w.uuid;let V=c[D];V===void 0&&(V={},c[D]=V);let G=V[O];G===void 0&&(G=S.clone(),V[O]=G,w.addEventListener("dispose",T)),S=G}if(S.visible=w.visible,S.wireframe=w.wireframe,x===Aa?S.side=w.shadowSide!==null?w.shadowSide:w.side:S.side=w.shadowSide!==null?w.shadowSide:h[w.side],S.alphaMap=w.alphaMap,S.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,S.map=w.map,S.clipShadows=w.clipShadows,S.clippingPlanes=w.clippingPlanes,S.clipIntersection=w.clipIntersection,S.displacementMap=w.displacementMap,S.displacementScale=w.displacementScale,S.displacementBias=w.displacementBias,S.wireframeLinewidth=w.wireframeLinewidth,S.linewidth=w.linewidth,L.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const D=r.properties.get(S);D.light=L}return S}function M(A,w,L,x,S){if(A.visible===!1)return;if(A.layers.test(w.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&S===Aa)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,A.matrixWorld);const O=e.update(A),V=A.material;if(Array.isArray(V)){const G=O.groups;for(let z=0,N=G.length;z<N;z++){const Y=G[z],ee=V[Y.materialIndex];if(ee&&ee.visible){const P=b(A,ee,x,S);A.onBeforeShadow(r,A,w,L,O,P,Y),r.renderBufferDirect(L,null,O,P,A,Y),A.onAfterShadow(r,A,w,L,O,P,Y)}}}else if(V.visible){const G=b(A,V,x,S);A.onBeforeShadow(r,A,w,L,O,G,null),r.renderBufferDirect(L,null,O,G,A,null),A.onAfterShadow(r,A,w,L,O,G,null)}}const D=A.children;for(let O=0,V=D.length;O<V;O++)M(D[O],w,L,x,S)}function T(A){A.target.removeEventListener("dispose",T);for(const L in c){const x=c[L],S=A.target.uuid;S in x&&(x[S].dispose(),delete x[S])}}}const Gy={[Qc]:eu,[tu]:ru,[nu]:su,[Qs]:iu,[eu]:Qc,[ru]:tu,[su]:nu,[iu]:Qs};function Hy(r,e){function t(){let I=!1;const ue=new Ft;let ne=null;const he=new Ft(0,0,0,0);return{setMask:function(te){ne!==te&&!I&&(r.colorMask(te,te,te,te),ne=te)},setLocked:function(te){I=te},setClear:function(te,Q,ce,Ie,ht){ht===!0&&(te*=Ie,Q*=Ie,ce*=Ie),ue.set(te,Q,ce,Ie),he.equals(ue)===!1&&(r.clearColor(te,Q,ce,Ie),he.copy(ue))},reset:function(){I=!1,ne=null,he.set(-1,0,0,0)}}}function n(){let I=!1,ue=!1,ne=null,he=null,te=null;return{setReversed:function(Q){if(ue!==Q){const ce=e.get("EXT_clip_control");Q?ce.clipControlEXT(ce.LOWER_LEFT_EXT,ce.ZERO_TO_ONE_EXT):ce.clipControlEXT(ce.LOWER_LEFT_EXT,ce.NEGATIVE_ONE_TO_ONE_EXT),ue=Q;const Ie=te;te=null,this.setClear(Ie)}},getReversed:function(){return ue},setTest:function(Q){Q?J(r.DEPTH_TEST):fe(r.DEPTH_TEST)},setMask:function(Q){ne!==Q&&!I&&(r.depthMask(Q),ne=Q)},setFunc:function(Q){if(ue&&(Q=Gy[Q]),he!==Q){switch(Q){case Qc:r.depthFunc(r.NEVER);break;case eu:r.depthFunc(r.ALWAYS);break;case tu:r.depthFunc(r.LESS);break;case Qs:r.depthFunc(r.LEQUAL);break;case nu:r.depthFunc(r.EQUAL);break;case iu:r.depthFunc(r.GEQUAL);break;case ru:r.depthFunc(r.GREATER);break;case su:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}he=Q}},setLocked:function(Q){I=Q},setClear:function(Q){te!==Q&&(ue&&(Q=1-Q),r.clearDepth(Q),te=Q)},reset:function(){I=!1,ne=null,he=null,te=null,ue=!1}}}function i(){let I=!1,ue=null,ne=null,he=null,te=null,Q=null,ce=null,Ie=null,ht=null;return{setTest:function(_e){I||(_e?J(r.STENCIL_TEST):fe(r.STENCIL_TEST))},setMask:function(_e){ue!==_e&&!I&&(r.stencilMask(_e),ue=_e)},setFunc:function(_e,Re,Ze){(ne!==_e||he!==Re||te!==Ze)&&(r.stencilFunc(_e,Re,Ze),ne=_e,he=Re,te=Ze)},setOp:function(_e,Re,Ze){(Q!==_e||ce!==Re||Ie!==Ze)&&(r.stencilOp(_e,Re,Ze),Q=_e,ce=Re,Ie=Ze)},setLocked:function(_e){I=_e},setClear:function(_e){ht!==_e&&(r.clearStencil(_e),ht=_e)},reset:function(){I=!1,ue=null,ne=null,he=null,te=null,Q=null,ce=null,Ie=null,ht=null}}}const s=new t,a=new n,o=new i,l=new WeakMap,c=new WeakMap;let u={},h={},d=new WeakMap,f=[],g=null,_=!1,m=null,p=null,E=null,b=null,M=null,T=null,A=null,w=new pt(0,0,0),L=0,x=!1,S=null,C=null,D=null,O=null,V=null;const G=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let z=!1,N=0;const Y=r.getParameter(r.VERSION);Y.indexOf("WebGL")!==-1?(N=parseFloat(/^WebGL (\d)/.exec(Y)[1]),z=N>=1):Y.indexOf("OpenGL ES")!==-1&&(N=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),z=N>=2);let ee=null,P={};const re=r.getParameter(r.SCISSOR_BOX),Le=r.getParameter(r.VIEWPORT),Oe=new Ft().fromArray(re),He=new Ft().fromArray(Le);function qe(I,ue,ne,he){const te=new Uint8Array(4),Q=r.createTexture();r.bindTexture(I,Q),r.texParameteri(I,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(I,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let ce=0;ce<ne;ce++)I===r.TEXTURE_3D||I===r.TEXTURE_2D_ARRAY?r.texImage3D(ue,0,r.RGBA,1,1,he,0,r.RGBA,r.UNSIGNED_BYTE,te):r.texImage2D(ue+ce,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,te);return Q}const K={};K[r.TEXTURE_2D]=qe(r.TEXTURE_2D,r.TEXTURE_2D,1),K[r.TEXTURE_CUBE_MAP]=qe(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),K[r.TEXTURE_2D_ARRAY]=qe(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),K[r.TEXTURE_3D]=qe(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),J(r.DEPTH_TEST),a.setFunc(Qs),Ue(!1),H(xf),J(r.CULL_FACE),Be(tr);function J(I){u[I]!==!0&&(r.enable(I),u[I]=!0)}function fe(I){u[I]!==!1&&(r.disable(I),u[I]=!1)}function Ce(I,ue){return h[I]!==ue?(r.bindFramebuffer(I,ue),h[I]=ue,I===r.DRAW_FRAMEBUFFER&&(h[r.FRAMEBUFFER]=ue),I===r.FRAMEBUFFER&&(h[r.DRAW_FRAMEBUFFER]=ue),!0):!1}function Se(I,ue){let ne=f,he=!1;if(I){ne=d.get(ue),ne===void 0&&(ne=[],d.set(ue,ne));const te=I.textures;if(ne.length!==te.length||ne[0]!==r.COLOR_ATTACHMENT0){for(let Q=0,ce=te.length;Q<ce;Q++)ne[Q]=r.COLOR_ATTACHMENT0+Q;ne.length=te.length,he=!0}}else ne[0]!==r.BACK&&(ne[0]=r.BACK,he=!0);he&&r.drawBuffers(ne)}function ke(I){return g!==I?(r.useProgram(I),g=I,!0):!1}const ot={[Yr]:r.FUNC_ADD,[Tg]:r.FUNC_SUBTRACT,[bg]:r.FUNC_REVERSE_SUBTRACT};ot[wg]=r.MIN,ot[Ag]=r.MAX;const Te={[Rg]:r.ZERO,[Cg]:r.ONE,[Pg]:r.SRC_COLOR,[jc]:r.SRC_ALPHA,[Fg]:r.SRC_ALPHA_SATURATE,[Ug]:r.DST_COLOR,[Lg]:r.DST_ALPHA,[Dg]:r.ONE_MINUS_SRC_COLOR,[Jc]:r.ONE_MINUS_SRC_ALPHA,[Ng]:r.ONE_MINUS_DST_COLOR,[Ig]:r.ONE_MINUS_DST_ALPHA,[Og]:r.CONSTANT_COLOR,[Bg]:r.ONE_MINUS_CONSTANT_COLOR,[zg]:r.CONSTANT_ALPHA,[kg]:r.ONE_MINUS_CONSTANT_ALPHA};function Be(I,ue,ne,he,te,Q,ce,Ie,ht,_e){if(I===tr){_===!0&&(fe(r.BLEND),_=!1);return}if(_===!1&&(J(r.BLEND),_=!0),I!==Eg){if(I!==m||_e!==x){if((p!==Yr||M!==Yr)&&(r.blendEquation(r.FUNC_ADD),p=Yr,M=Yr),_e)switch(I){case Ws:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case vf:r.blendFunc(r.ONE,r.ONE);break;case Sf:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Mf:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:lt("WebGLState: Invalid blending: ",I);break}else switch(I){case Ws:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case vf:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case Sf:lt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Mf:lt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:lt("WebGLState: Invalid blending: ",I);break}E=null,b=null,T=null,A=null,w.set(0,0,0),L=0,m=I,x=_e}return}te=te||ue,Q=Q||ne,ce=ce||he,(ue!==p||te!==M)&&(r.blendEquationSeparate(ot[ue],ot[te]),p=ue,M=te),(ne!==E||he!==b||Q!==T||ce!==A)&&(r.blendFuncSeparate(Te[ne],Te[he],Te[Q],Te[ce]),E=ne,b=he,T=Q,A=ce),(Ie.equals(w)===!1||ht!==L)&&(r.blendColor(Ie.r,Ie.g,Ie.b,ht),w.copy(Ie),L=ht),m=I,x=!1}function Ke(I,ue){I.side===Zi?fe(r.CULL_FACE):J(r.CULL_FACE);let ne=I.side===Bn;ue&&(ne=!ne),Ue(ne),I.blending===Ws&&I.transparent===!1?Be(tr):Be(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),a.setFunc(I.depthFunc),a.setTest(I.depthTest),a.setMask(I.depthWrite),s.setMask(I.colorWrite);const he=I.stencilWrite;o.setTest(he),he&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),mt(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?J(r.SAMPLE_ALPHA_TO_COVERAGE):fe(r.SAMPLE_ALPHA_TO_COVERAGE)}function Ue(I){S!==I&&(I?r.frontFace(r.CW):r.frontFace(r.CCW),S=I)}function H(I){I!==Sg?(J(r.CULL_FACE),I!==C&&(I===xf?r.cullFace(r.BACK):I===Mg?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):fe(r.CULL_FACE),C=I}function U(I){I!==D&&(z&&r.lineWidth(I),D=I)}function mt(I,ue,ne){I?(J(r.POLYGON_OFFSET_FILL),(O!==ue||V!==ne)&&(r.polygonOffset(ue,ne),O=ue,V=ne)):fe(r.POLYGON_OFFSET_FILL)}function Qe(I){I?J(r.SCISSOR_TEST):fe(r.SCISSOR_TEST)}function ze(I){I===void 0&&(I=r.TEXTURE0+G-1),ee!==I&&(r.activeTexture(I),ee=I)}function Me(I,ue,ne){ne===void 0&&(ee===null?ne=r.TEXTURE0+G-1:ne=ee);let he=P[ne];he===void 0&&(he={type:void 0,texture:void 0},P[ne]=he),(he.type!==I||he.texture!==ue)&&(ee!==ne&&(r.activeTexture(ne),ee=ne),r.bindTexture(I,ue||K[I]),he.type=I,he.texture=ue)}function R(){const I=P[ee];I!==void 0&&I.type!==void 0&&(r.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function v(){try{r.compressedTexImage2D(...arguments)}catch(I){lt("WebGLState:",I)}}function F(){try{r.compressedTexImage3D(...arguments)}catch(I){lt("WebGLState:",I)}}function Z(){try{r.texSubImage2D(...arguments)}catch(I){lt("WebGLState:",I)}}function j(){try{r.texSubImage3D(...arguments)}catch(I){lt("WebGLState:",I)}}function $(){try{r.compressedTexSubImage2D(...arguments)}catch(I){lt("WebGLState:",I)}}function ve(){try{r.compressedTexSubImage3D(...arguments)}catch(I){lt("WebGLState:",I)}}function se(){try{r.texStorage2D(...arguments)}catch(I){lt("WebGLState:",I)}}function be(){try{r.texStorage3D(...arguments)}catch(I){lt("WebGLState:",I)}}function Ee(){try{r.texImage2D(...arguments)}catch(I){lt("WebGLState:",I)}}function ie(){try{r.texImage3D(...arguments)}catch(I){lt("WebGLState:",I)}}function ae(I){Oe.equals(I)===!1&&(r.scissor(I.x,I.y,I.z,I.w),Oe.copy(I))}function ye(I){He.equals(I)===!1&&(r.viewport(I.x,I.y,I.z,I.w),He.copy(I))}function we(I,ue){let ne=c.get(ue);ne===void 0&&(ne=new WeakMap,c.set(ue,ne));let he=ne.get(I);he===void 0&&(he=r.getUniformBlockIndex(ue,I.name),ne.set(I,he))}function oe(I,ue){const he=c.get(ue).get(I);l.get(ue)!==he&&(r.uniformBlockBinding(ue,he,I.__bindingPointIndex),l.set(ue,he))}function Ge(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),a.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),u={},ee=null,P={},h={},d=new WeakMap,f=[],g=null,_=!1,m=null,p=null,E=null,b=null,M=null,T=null,A=null,w=new pt(0,0,0),L=0,x=!1,S=null,C=null,D=null,O=null,V=null,Oe.set(0,0,r.canvas.width,r.canvas.height),He.set(0,0,r.canvas.width,r.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:J,disable:fe,bindFramebuffer:Ce,drawBuffers:Se,useProgram:ke,setBlending:Be,setMaterial:Ke,setFlipSided:Ue,setCullFace:H,setLineWidth:U,setPolygonOffset:mt,setScissorTest:Qe,activeTexture:ze,bindTexture:Me,unbindTexture:R,compressedTexImage2D:v,compressedTexImage3D:F,texImage2D:Ee,texImage3D:ie,updateUBOMapping:we,uniformBlockBinding:oe,texStorage2D:se,texStorage3D:be,texSubImage2D:Z,texSubImage3D:j,compressedTexSubImage2D:$,compressedTexSubImage3D:ve,scissor:ae,viewport:ye,reset:Ge}}function Wy(r,e,t,n,i,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ut,u=new WeakMap;let h;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(R,v){return f?new OffscreenCanvas(R,v):no("canvas")}function _(R,v,F){let Z=1;const j=Me(R);if((j.width>F||j.height>F)&&(Z=F/Math.max(j.width,j.height)),Z<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){const $=Math.floor(Z*j.width),ve=Math.floor(Z*j.height);h===void 0&&(h=g($,ve));const se=v?g($,ve):h;return se.width=$,se.height=ve,se.getContext("2d").drawImage(R,0,0,$,ve),Ye("WebGLRenderer: Texture has been resized from ("+j.width+"x"+j.height+") to ("+$+"x"+ve+")."),se}else return"data"in R&&Ye("WebGLRenderer: Image in DataTexture is too big ("+j.width+"x"+j.height+")."),R;return R}function m(R){return R.generateMipmaps}function p(R){r.generateMipmap(R)}function E(R){return R.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?r.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function b(R,v,F,Z,j=!1){if(R!==null){if(r[R]!==void 0)return r[R];Ye("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let $=v;if(v===r.RED&&(F===r.FLOAT&&($=r.R32F),F===r.HALF_FLOAT&&($=r.R16F),F===r.UNSIGNED_BYTE&&($=r.R8)),v===r.RED_INTEGER&&(F===r.UNSIGNED_BYTE&&($=r.R8UI),F===r.UNSIGNED_SHORT&&($=r.R16UI),F===r.UNSIGNED_INT&&($=r.R32UI),F===r.BYTE&&($=r.R8I),F===r.SHORT&&($=r.R16I),F===r.INT&&($=r.R32I)),v===r.RG&&(F===r.FLOAT&&($=r.RG32F),F===r.HALF_FLOAT&&($=r.RG16F),F===r.UNSIGNED_BYTE&&($=r.RG8)),v===r.RG_INTEGER&&(F===r.UNSIGNED_BYTE&&($=r.RG8UI),F===r.UNSIGNED_SHORT&&($=r.RG16UI),F===r.UNSIGNED_INT&&($=r.RG32UI),F===r.BYTE&&($=r.RG8I),F===r.SHORT&&($=r.RG16I),F===r.INT&&($=r.RG32I)),v===r.RGB_INTEGER&&(F===r.UNSIGNED_BYTE&&($=r.RGB8UI),F===r.UNSIGNED_SHORT&&($=r.RGB16UI),F===r.UNSIGNED_INT&&($=r.RGB32UI),F===r.BYTE&&($=r.RGB8I),F===r.SHORT&&($=r.RGB16I),F===r.INT&&($=r.RGB32I)),v===r.RGBA_INTEGER&&(F===r.UNSIGNED_BYTE&&($=r.RGBA8UI),F===r.UNSIGNED_SHORT&&($=r.RGBA16UI),F===r.UNSIGNED_INT&&($=r.RGBA32UI),F===r.BYTE&&($=r.RGBA8I),F===r.SHORT&&($=r.RGBA16I),F===r.INT&&($=r.RGBA32I)),v===r.RGB&&(F===r.UNSIGNED_INT_5_9_9_9_REV&&($=r.RGB9_E5),F===r.UNSIGNED_INT_10F_11F_11F_REV&&($=r.R11F_G11F_B10F)),v===r.RGBA){const ve=j?vl:ct.getTransfer(Z);F===r.FLOAT&&($=r.RGBA32F),F===r.HALF_FLOAT&&($=r.RGBA16F),F===r.UNSIGNED_BYTE&&($=ve===vt?r.SRGB8_ALPHA8:r.RGBA8),F===r.UNSIGNED_SHORT_4_4_4_4&&($=r.RGBA4),F===r.UNSIGNED_SHORT_5_5_5_1&&($=r.RGB5_A1)}return($===r.R16F||$===r.R32F||$===r.RG16F||$===r.RG32F||$===r.RGBA16F||$===r.RGBA32F)&&e.get("EXT_color_buffer_float"),$}function M(R,v){let F;return R?v===null||v===Oi||v===to?F=r.DEPTH24_STENCIL8:v===Pi?F=r.DEPTH32F_STENCIL8:v===eo&&(F=r.DEPTH24_STENCIL8,Ye("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Oi||v===to?F=r.DEPTH_COMPONENT24:v===Pi?F=r.DEPTH_COMPONENT32F:v===eo&&(F=r.DEPTH_COMPONENT16),F}function T(R,v){return m(R)===!0||R.isFramebufferTexture&&R.minFilter!==on&&R.minFilter!==gn?Math.log2(Math.max(v.width,v.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?v.mipmaps.length:1}function A(R){const v=R.target;v.removeEventListener("dispose",A),L(v),v.isVideoTexture&&u.delete(v)}function w(R){const v=R.target;v.removeEventListener("dispose",w),S(v)}function L(R){const v=n.get(R);if(v.__webglInit===void 0)return;const F=R.source,Z=d.get(F);if(Z){const j=Z[v.__cacheKey];j.usedTimes--,j.usedTimes===0&&x(R),Object.keys(Z).length===0&&d.delete(F)}n.remove(R)}function x(R){const v=n.get(R);r.deleteTexture(v.__webglTexture);const F=R.source,Z=d.get(F);delete Z[v.__cacheKey],a.memory.textures--}function S(R){const v=n.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),n.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(v.__webglFramebuffer[Z]))for(let j=0;j<v.__webglFramebuffer[Z].length;j++)r.deleteFramebuffer(v.__webglFramebuffer[Z][j]);else r.deleteFramebuffer(v.__webglFramebuffer[Z]);v.__webglDepthbuffer&&r.deleteRenderbuffer(v.__webglDepthbuffer[Z])}else{if(Array.isArray(v.__webglFramebuffer))for(let Z=0;Z<v.__webglFramebuffer.length;Z++)r.deleteFramebuffer(v.__webglFramebuffer[Z]);else r.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&r.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&r.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let Z=0;Z<v.__webglColorRenderbuffer.length;Z++)v.__webglColorRenderbuffer[Z]&&r.deleteRenderbuffer(v.__webglColorRenderbuffer[Z]);v.__webglDepthRenderbuffer&&r.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const F=R.textures;for(let Z=0,j=F.length;Z<j;Z++){const $=n.get(F[Z]);$.__webglTexture&&(r.deleteTexture($.__webglTexture),a.memory.textures--),n.remove(F[Z])}n.remove(R)}let C=0;function D(){C=0}function O(){const R=C;return R>=i.maxTextures&&Ye("WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+i.maxTextures),C+=1,R}function V(R){const v=[];return v.push(R.wrapS),v.push(R.wrapT),v.push(R.wrapR||0),v.push(R.magFilter),v.push(R.minFilter),v.push(R.anisotropy),v.push(R.internalFormat),v.push(R.format),v.push(R.type),v.push(R.generateMipmaps),v.push(R.premultiplyAlpha),v.push(R.flipY),v.push(R.unpackAlignment),v.push(R.colorSpace),v.join()}function G(R,v){const F=n.get(R);if(R.isVideoTexture&&Qe(R),R.isRenderTargetTexture===!1&&R.isExternalTexture!==!0&&R.version>0&&F.__version!==R.version){const Z=R.image;if(Z===null)Ye("WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)Ye("WebGLRenderer: Texture marked for update but image is incomplete");else{K(F,R,v);return}}else R.isExternalTexture&&(F.__webglTexture=R.sourceTexture?R.sourceTexture:null);t.bindTexture(r.TEXTURE_2D,F.__webglTexture,r.TEXTURE0+v)}function z(R,v){const F=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&F.__version!==R.version){K(F,R,v);return}else R.isExternalTexture&&(F.__webglTexture=R.sourceTexture?R.sourceTexture:null);t.bindTexture(r.TEXTURE_2D_ARRAY,F.__webglTexture,r.TEXTURE0+v)}function N(R,v){const F=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&F.__version!==R.version){K(F,R,v);return}t.bindTexture(r.TEXTURE_3D,F.__webglTexture,r.TEXTURE0+v)}function Y(R,v){const F=n.get(R);if(R.isCubeDepthTexture!==!0&&R.version>0&&F.__version!==R.version){J(F,R,v);return}t.bindTexture(r.TEXTURE_CUBE_MAP,F.__webglTexture,r.TEXTURE0+v)}const ee={[lu]:r.REPEAT,[Qi]:r.CLAMP_TO_EDGE,[cu]:r.MIRRORED_REPEAT},P={[on]:r.NEAREST,[Hg]:r.NEAREST_MIPMAP_NEAREST,[To]:r.NEAREST_MIPMAP_LINEAR,[gn]:r.LINEAR,[$l]:r.LINEAR_MIPMAP_NEAREST,[Zr]:r.LINEAR_MIPMAP_LINEAR},re={[Yg]:r.NEVER,[jg]:r.ALWAYS,[qg]:r.LESS,[Th]:r.LEQUAL,[$g]:r.EQUAL,[bh]:r.GEQUAL,[Kg]:r.GREATER,[Zg]:r.NOTEQUAL};function Le(R,v){if(v.type===Pi&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===gn||v.magFilter===$l||v.magFilter===To||v.magFilter===Zr||v.minFilter===gn||v.minFilter===$l||v.minFilter===To||v.minFilter===Zr)&&Ye("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(R,r.TEXTURE_WRAP_S,ee[v.wrapS]),r.texParameteri(R,r.TEXTURE_WRAP_T,ee[v.wrapT]),(R===r.TEXTURE_3D||R===r.TEXTURE_2D_ARRAY)&&r.texParameteri(R,r.TEXTURE_WRAP_R,ee[v.wrapR]),r.texParameteri(R,r.TEXTURE_MAG_FILTER,P[v.magFilter]),r.texParameteri(R,r.TEXTURE_MIN_FILTER,P[v.minFilter]),v.compareFunction&&(r.texParameteri(R,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(R,r.TEXTURE_COMPARE_FUNC,re[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===on||v.minFilter!==To&&v.minFilter!==Zr||v.type===Pi&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");r.texParameterf(R,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,i.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function Oe(R,v){let F=!1;R.__webglInit===void 0&&(R.__webglInit=!0,v.addEventListener("dispose",A));const Z=v.source;let j=d.get(Z);j===void 0&&(j={},d.set(Z,j));const $=V(v);if($!==R.__cacheKey){j[$]===void 0&&(j[$]={texture:r.createTexture(),usedTimes:0},a.memory.textures++,F=!0),j[$].usedTimes++;const ve=j[R.__cacheKey];ve!==void 0&&(j[R.__cacheKey].usedTimes--,ve.usedTimes===0&&x(v)),R.__cacheKey=$,R.__webglTexture=j[$].texture}return F}function He(R,v,F){return Math.floor(Math.floor(R/F)/v)}function qe(R,v,F,Z){const $=R.updateRanges;if($.length===0)t.texSubImage2D(r.TEXTURE_2D,0,0,0,v.width,v.height,F,Z,v.data);else{$.sort((ie,ae)=>ie.start-ae.start);let ve=0;for(let ie=1;ie<$.length;ie++){const ae=$[ve],ye=$[ie],we=ae.start+ae.count,oe=He(ye.start,v.width,4),Ge=He(ae.start,v.width,4);ye.start<=we+1&&oe===Ge&&He(ye.start+ye.count-1,v.width,4)===oe?ae.count=Math.max(ae.count,ye.start+ye.count-ae.start):(++ve,$[ve]=ye)}$.length=ve+1;const se=r.getParameter(r.UNPACK_ROW_LENGTH),be=r.getParameter(r.UNPACK_SKIP_PIXELS),Ee=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,v.width);for(let ie=0,ae=$.length;ie<ae;ie++){const ye=$[ie],we=Math.floor(ye.start/4),oe=Math.ceil(ye.count/4),Ge=we%v.width,I=Math.floor(we/v.width),ue=oe,ne=1;r.pixelStorei(r.UNPACK_SKIP_PIXELS,Ge),r.pixelStorei(r.UNPACK_SKIP_ROWS,I),t.texSubImage2D(r.TEXTURE_2D,0,Ge,I,ue,ne,F,Z,v.data)}R.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,se),r.pixelStorei(r.UNPACK_SKIP_PIXELS,be),r.pixelStorei(r.UNPACK_SKIP_ROWS,Ee)}}function K(R,v,F){let Z=r.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(Z=r.TEXTURE_2D_ARRAY),v.isData3DTexture&&(Z=r.TEXTURE_3D);const j=Oe(R,v),$=v.source;t.bindTexture(Z,R.__webglTexture,r.TEXTURE0+F);const ve=n.get($);if($.version!==ve.__version||j===!0){t.activeTexture(r.TEXTURE0+F);const se=ct.getPrimaries(ct.workingColorSpace),be=v.colorSpace===_r?null:ct.getPrimaries(v.colorSpace),Ee=v.colorSpace===_r||se===be?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,v.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,v.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);let ie=_(v.image,!1,i.maxTextureSize);ie=ze(v,ie);const ae=s.convert(v.format,v.colorSpace),ye=s.convert(v.type);let we=b(v.internalFormat,ae,ye,v.colorSpace,v.isVideoTexture);Le(Z,v);let oe;const Ge=v.mipmaps,I=v.isVideoTexture!==!0,ue=ve.__version===void 0||j===!0,ne=$.dataReady,he=T(v,ie);if(v.isDepthTexture)we=M(v.format===jr,v.type),ue&&(I?t.texStorage2D(r.TEXTURE_2D,1,we,ie.width,ie.height):t.texImage2D(r.TEXTURE_2D,0,we,ie.width,ie.height,0,ae,ye,null));else if(v.isDataTexture)if(Ge.length>0){I&&ue&&t.texStorage2D(r.TEXTURE_2D,he,we,Ge[0].width,Ge[0].height);for(let te=0,Q=Ge.length;te<Q;te++)oe=Ge[te],I?ne&&t.texSubImage2D(r.TEXTURE_2D,te,0,0,oe.width,oe.height,ae,ye,oe.data):t.texImage2D(r.TEXTURE_2D,te,we,oe.width,oe.height,0,ae,ye,oe.data);v.generateMipmaps=!1}else I?(ue&&t.texStorage2D(r.TEXTURE_2D,he,we,ie.width,ie.height),ne&&qe(v,ie,ae,ye)):t.texImage2D(r.TEXTURE_2D,0,we,ie.width,ie.height,0,ae,ye,ie.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){I&&ue&&t.texStorage3D(r.TEXTURE_2D_ARRAY,he,we,Ge[0].width,Ge[0].height,ie.depth);for(let te=0,Q=Ge.length;te<Q;te++)if(oe=Ge[te],v.format!==yi)if(ae!==null)if(I){if(ne)if(v.layerUpdates.size>0){const ce=Kf(oe.width,oe.height,v.format,v.type);for(const Ie of v.layerUpdates){const ht=oe.data.subarray(Ie*ce/oe.data.BYTES_PER_ELEMENT,(Ie+1)*ce/oe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,te,0,0,Ie,oe.width,oe.height,1,ae,ht)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,te,0,0,0,oe.width,oe.height,ie.depth,ae,oe.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,te,we,oe.width,oe.height,ie.depth,0,oe.data,0,0);else Ye("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else I?ne&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,te,0,0,0,oe.width,oe.height,ie.depth,ae,ye,oe.data):t.texImage3D(r.TEXTURE_2D_ARRAY,te,we,oe.width,oe.height,ie.depth,0,ae,ye,oe.data)}else{I&&ue&&t.texStorage2D(r.TEXTURE_2D,he,we,Ge[0].width,Ge[0].height);for(let te=0,Q=Ge.length;te<Q;te++)oe=Ge[te],v.format!==yi?ae!==null?I?ne&&t.compressedTexSubImage2D(r.TEXTURE_2D,te,0,0,oe.width,oe.height,ae,oe.data):t.compressedTexImage2D(r.TEXTURE_2D,te,we,oe.width,oe.height,0,oe.data):Ye("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):I?ne&&t.texSubImage2D(r.TEXTURE_2D,te,0,0,oe.width,oe.height,ae,ye,oe.data):t.texImage2D(r.TEXTURE_2D,te,we,oe.width,oe.height,0,ae,ye,oe.data)}else if(v.isDataArrayTexture)if(I){if(ue&&t.texStorage3D(r.TEXTURE_2D_ARRAY,he,we,ie.width,ie.height,ie.depth),ne)if(v.layerUpdates.size>0){const te=Kf(ie.width,ie.height,v.format,v.type);for(const Q of v.layerUpdates){const ce=ie.data.subarray(Q*te/ie.data.BYTES_PER_ELEMENT,(Q+1)*te/ie.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,Q,ie.width,ie.height,1,ae,ye,ce)}v.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,ie.width,ie.height,ie.depth,ae,ye,ie.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,we,ie.width,ie.height,ie.depth,0,ae,ye,ie.data);else if(v.isData3DTexture)I?(ue&&t.texStorage3D(r.TEXTURE_3D,he,we,ie.width,ie.height,ie.depth),ne&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,ie.width,ie.height,ie.depth,ae,ye,ie.data)):t.texImage3D(r.TEXTURE_3D,0,we,ie.width,ie.height,ie.depth,0,ae,ye,ie.data);else if(v.isFramebufferTexture){if(ue)if(I)t.texStorage2D(r.TEXTURE_2D,he,we,ie.width,ie.height);else{let te=ie.width,Q=ie.height;for(let ce=0;ce<he;ce++)t.texImage2D(r.TEXTURE_2D,ce,we,te,Q,0,ae,ye,null),te>>=1,Q>>=1}}else if(Ge.length>0){if(I&&ue){const te=Me(Ge[0]);t.texStorage2D(r.TEXTURE_2D,he,we,te.width,te.height)}for(let te=0,Q=Ge.length;te<Q;te++)oe=Ge[te],I?ne&&t.texSubImage2D(r.TEXTURE_2D,te,0,0,ae,ye,oe):t.texImage2D(r.TEXTURE_2D,te,we,ae,ye,oe);v.generateMipmaps=!1}else if(I){if(ue){const te=Me(ie);t.texStorage2D(r.TEXTURE_2D,he,we,te.width,te.height)}ne&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,ae,ye,ie)}else t.texImage2D(r.TEXTURE_2D,0,we,ae,ye,ie);m(v)&&p(Z),ve.__version=$.version,v.onUpdate&&v.onUpdate(v)}R.__version=v.version}function J(R,v,F){if(v.image.length!==6)return;const Z=Oe(R,v),j=v.source;t.bindTexture(r.TEXTURE_CUBE_MAP,R.__webglTexture,r.TEXTURE0+F);const $=n.get(j);if(j.version!==$.__version||Z===!0){t.activeTexture(r.TEXTURE0+F);const ve=ct.getPrimaries(ct.workingColorSpace),se=v.colorSpace===_r?null:ct.getPrimaries(v.colorSpace),be=v.colorSpace===_r||ve===se?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,v.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,v.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,be);const Ee=v.isCompressedTexture||v.image[0].isCompressedTexture,ie=v.image[0]&&v.image[0].isDataTexture,ae=[];for(let Q=0;Q<6;Q++)!Ee&&!ie?ae[Q]=_(v.image[Q],!0,i.maxCubemapSize):ae[Q]=ie?v.image[Q].image:v.image[Q],ae[Q]=ze(v,ae[Q]);const ye=ae[0],we=s.convert(v.format,v.colorSpace),oe=s.convert(v.type),Ge=b(v.internalFormat,we,oe,v.colorSpace),I=v.isVideoTexture!==!0,ue=$.__version===void 0||Z===!0,ne=j.dataReady;let he=T(v,ye);Le(r.TEXTURE_CUBE_MAP,v);let te;if(Ee){I&&ue&&t.texStorage2D(r.TEXTURE_CUBE_MAP,he,Ge,ye.width,ye.height);for(let Q=0;Q<6;Q++){te=ae[Q].mipmaps;for(let ce=0;ce<te.length;ce++){const Ie=te[ce];v.format!==yi?we!==null?I?ne&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ce,0,0,Ie.width,Ie.height,we,Ie.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ce,Ge,Ie.width,Ie.height,0,Ie.data):Ye("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?ne&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ce,0,0,Ie.width,Ie.height,we,oe,Ie.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ce,Ge,Ie.width,Ie.height,0,we,oe,Ie.data)}}}else{if(te=v.mipmaps,I&&ue){te.length>0&&he++;const Q=Me(ae[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,he,Ge,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(ie){I?ne&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,ae[Q].width,ae[Q].height,we,oe,ae[Q].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ge,ae[Q].width,ae[Q].height,0,we,oe,ae[Q].data);for(let ce=0;ce<te.length;ce++){const ht=te[ce].image[Q].image;I?ne&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ce+1,0,0,ht.width,ht.height,we,oe,ht.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ce+1,Ge,ht.width,ht.height,0,we,oe,ht.data)}}else{I?ne&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,we,oe,ae[Q]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ge,we,oe,ae[Q]);for(let ce=0;ce<te.length;ce++){const Ie=te[ce];I?ne&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ce+1,0,0,we,oe,Ie.image[Q]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ce+1,Ge,we,oe,Ie.image[Q])}}}m(v)&&p(r.TEXTURE_CUBE_MAP),$.__version=j.version,v.onUpdate&&v.onUpdate(v)}R.__version=v.version}function fe(R,v,F,Z,j,$){const ve=s.convert(F.format,F.colorSpace),se=s.convert(F.type),be=b(F.internalFormat,ve,se,F.colorSpace),Ee=n.get(v),ie=n.get(F);if(ie.__renderTarget=v,!Ee.__hasExternalTextures){const ae=Math.max(1,v.width>>$),ye=Math.max(1,v.height>>$);j===r.TEXTURE_3D||j===r.TEXTURE_2D_ARRAY?t.texImage3D(j,$,be,ae,ye,v.depth,0,ve,se,null):t.texImage2D(j,$,be,ae,ye,0,ve,se,null)}t.bindFramebuffer(r.FRAMEBUFFER,R),mt(v)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Z,j,ie.__webglTexture,0,U(v)):(j===r.TEXTURE_2D||j>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&j<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,Z,j,ie.__webglTexture,$),t.bindFramebuffer(r.FRAMEBUFFER,null)}function Ce(R,v,F){if(r.bindRenderbuffer(r.RENDERBUFFER,R),v.depthBuffer){const Z=v.depthTexture,j=Z&&Z.isDepthTexture?Z.type:null,$=M(v.stencilBuffer,j),ve=v.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;mt(v)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,U(v),$,v.width,v.height):F?r.renderbufferStorageMultisample(r.RENDERBUFFER,U(v),$,v.width,v.height):r.renderbufferStorage(r.RENDERBUFFER,$,v.width,v.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,ve,r.RENDERBUFFER,R)}else{const Z=v.textures;for(let j=0;j<Z.length;j++){const $=Z[j],ve=s.convert($.format,$.colorSpace),se=s.convert($.type),be=b($.internalFormat,ve,se,$.colorSpace);mt(v)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,U(v),be,v.width,v.height):F?r.renderbufferStorageMultisample(r.RENDERBUFFER,U(v),be,v.width,v.height):r.renderbufferStorage(r.RENDERBUFFER,be,v.width,v.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function Se(R,v,F){const Z=v.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(r.FRAMEBUFFER,R),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const j=n.get(v.depthTexture);if(j.__renderTarget=v,(!j.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),Z){if(j.__webglInit===void 0&&(j.__webglInit=!0,v.depthTexture.addEventListener("dispose",A)),j.__webglTexture===void 0){j.__webglTexture=r.createTexture(),t.bindTexture(r.TEXTURE_CUBE_MAP,j.__webglTexture),Le(r.TEXTURE_CUBE_MAP,v.depthTexture);const Ee=s.convert(v.depthTexture.format),ie=s.convert(v.depthTexture.type);let ae;v.depthTexture.format===or?ae=r.DEPTH_COMPONENT24:v.depthTexture.format===jr&&(ae=r.DEPTH24_STENCIL8);for(let ye=0;ye<6;ye++)r.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+ye,0,ae,v.width,v.height,0,Ee,ie,null)}}else G(v.depthTexture,0);const $=j.__webglTexture,ve=U(v),se=Z?r.TEXTURE_CUBE_MAP_POSITIVE_X+F:r.TEXTURE_2D,be=v.depthTexture.format===jr?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;if(v.depthTexture.format===or)mt(v)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,be,se,$,0,ve):r.framebufferTexture2D(r.FRAMEBUFFER,be,se,$,0);else if(v.depthTexture.format===jr)mt(v)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,be,se,$,0,ve):r.framebufferTexture2D(r.FRAMEBUFFER,be,se,$,0);else throw new Error("Unknown depthTexture format")}function ke(R){const v=n.get(R),F=R.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==R.depthTexture){const Z=R.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),Z){const j=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,Z.removeEventListener("dispose",j)};Z.addEventListener("dispose",j),v.__depthDisposeCallback=j}v.__boundDepthTexture=Z}if(R.depthTexture&&!v.__autoAllocateDepthBuffer)if(F)for(let Z=0;Z<6;Z++)Se(v.__webglFramebuffer[Z],R,Z);else{const Z=R.texture.mipmaps;Z&&Z.length>0?Se(v.__webglFramebuffer[0],R,0):Se(v.__webglFramebuffer,R,0)}else if(F){v.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer[Z]),v.__webglDepthbuffer[Z]===void 0)v.__webglDepthbuffer[Z]=r.createRenderbuffer(),Ce(v.__webglDepthbuffer[Z],R,!1);else{const j=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,$=v.__webglDepthbuffer[Z];r.bindRenderbuffer(r.RENDERBUFFER,$),r.framebufferRenderbuffer(r.FRAMEBUFFER,j,r.RENDERBUFFER,$)}}else{const Z=R.texture.mipmaps;if(Z&&Z.length>0?t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer[0]):t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=r.createRenderbuffer(),Ce(v.__webglDepthbuffer,R,!1);else{const j=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,$=v.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,$),r.framebufferRenderbuffer(r.FRAMEBUFFER,j,r.RENDERBUFFER,$)}}t.bindFramebuffer(r.FRAMEBUFFER,null)}function ot(R,v,F){const Z=n.get(R);v!==void 0&&fe(Z.__webglFramebuffer,R,R.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),F!==void 0&&ke(R)}function Te(R){const v=R.texture,F=n.get(R),Z=n.get(v);R.addEventListener("dispose",w);const j=R.textures,$=R.isWebGLCubeRenderTarget===!0,ve=j.length>1;if(ve||(Z.__webglTexture===void 0&&(Z.__webglTexture=r.createTexture()),Z.__version=v.version,a.memory.textures++),$){F.__webglFramebuffer=[];for(let se=0;se<6;se++)if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer[se]=[];for(let be=0;be<v.mipmaps.length;be++)F.__webglFramebuffer[se][be]=r.createFramebuffer()}else F.__webglFramebuffer[se]=r.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer=[];for(let se=0;se<v.mipmaps.length;se++)F.__webglFramebuffer[se]=r.createFramebuffer()}else F.__webglFramebuffer=r.createFramebuffer();if(ve)for(let se=0,be=j.length;se<be;se++){const Ee=n.get(j[se]);Ee.__webglTexture===void 0&&(Ee.__webglTexture=r.createTexture(),a.memory.textures++)}if(R.samples>0&&mt(R)===!1){F.__webglMultisampledFramebuffer=r.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let se=0;se<j.length;se++){const be=j[se];F.__webglColorRenderbuffer[se]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,F.__webglColorRenderbuffer[se]);const Ee=s.convert(be.format,be.colorSpace),ie=s.convert(be.type),ae=b(be.internalFormat,Ee,ie,be.colorSpace,R.isXRRenderTarget===!0),ye=U(R);r.renderbufferStorageMultisample(r.RENDERBUFFER,ye,ae,R.width,R.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+se,r.RENDERBUFFER,F.__webglColorRenderbuffer[se])}r.bindRenderbuffer(r.RENDERBUFFER,null),R.depthBuffer&&(F.__webglDepthRenderbuffer=r.createRenderbuffer(),Ce(F.__webglDepthRenderbuffer,R,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if($){t.bindTexture(r.TEXTURE_CUBE_MAP,Z.__webglTexture),Le(r.TEXTURE_CUBE_MAP,v);for(let se=0;se<6;se++)if(v.mipmaps&&v.mipmaps.length>0)for(let be=0;be<v.mipmaps.length;be++)fe(F.__webglFramebuffer[se][be],R,v,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+se,be);else fe(F.__webglFramebuffer[se],R,v,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+se,0);m(v)&&p(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ve){for(let se=0,be=j.length;se<be;se++){const Ee=j[se],ie=n.get(Ee);let ae=r.TEXTURE_2D;(R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(ae=R.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(ae,ie.__webglTexture),Le(ae,Ee),fe(F.__webglFramebuffer,R,Ee,r.COLOR_ATTACHMENT0+se,ae,0),m(Ee)&&p(ae)}t.unbindTexture()}else{let se=r.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(se=R.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(se,Z.__webglTexture),Le(se,v),v.mipmaps&&v.mipmaps.length>0)for(let be=0;be<v.mipmaps.length;be++)fe(F.__webglFramebuffer[be],R,v,r.COLOR_ATTACHMENT0,se,be);else fe(F.__webglFramebuffer,R,v,r.COLOR_ATTACHMENT0,se,0);m(v)&&p(se),t.unbindTexture()}R.depthBuffer&&ke(R)}function Be(R){const v=R.textures;for(let F=0,Z=v.length;F<Z;F++){const j=v[F];if(m(j)){const $=E(R),ve=n.get(j).__webglTexture;t.bindTexture($,ve),p($),t.unbindTexture()}}}const Ke=[],Ue=[];function H(R){if(R.samples>0){if(mt(R)===!1){const v=R.textures,F=R.width,Z=R.height;let j=r.COLOR_BUFFER_BIT;const $=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ve=n.get(R),se=v.length>1;if(se)for(let Ee=0;Ee<v.length;Ee++)t.bindFramebuffer(r.FRAMEBUFFER,ve.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ee,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,ve.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ee,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,ve.__webglMultisampledFramebuffer);const be=R.texture.mipmaps;be&&be.length>0?t.bindFramebuffer(r.DRAW_FRAMEBUFFER,ve.__webglFramebuffer[0]):t.bindFramebuffer(r.DRAW_FRAMEBUFFER,ve.__webglFramebuffer);for(let Ee=0;Ee<v.length;Ee++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(j|=r.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(j|=r.STENCIL_BUFFER_BIT)),se){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,ve.__webglColorRenderbuffer[Ee]);const ie=n.get(v[Ee]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,ie,0)}r.blitFramebuffer(0,0,F,Z,0,0,F,Z,j,r.NEAREST),l===!0&&(Ke.length=0,Ue.length=0,Ke.push(r.COLOR_ATTACHMENT0+Ee),R.depthBuffer&&R.resolveDepthBuffer===!1&&(Ke.push($),Ue.push($),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,Ue)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,Ke))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),se)for(let Ee=0;Ee<v.length;Ee++){t.bindFramebuffer(r.FRAMEBUFFER,ve.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ee,r.RENDERBUFFER,ve.__webglColorRenderbuffer[Ee]);const ie=n.get(v[Ee]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,ve.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ee,r.TEXTURE_2D,ie,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,ve.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&l){const v=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[v])}}}function U(R){return Math.min(i.maxSamples,R.samples)}function mt(R){const v=n.get(R);return R.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function Qe(R){const v=a.render.frame;u.get(R)!==v&&(u.set(R,v),R.update())}function ze(R,v){const F=R.colorSpace,Z=R.format,j=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||F!==na&&F!==_r&&(ct.getTransfer(F)===vt?(Z!==yi||j!==Qn)&&Ye("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):lt("WebGLTextures: Unsupported texture color space:",F)),v}function Me(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(c.width=R.naturalWidth||R.width,c.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(c.width=R.displayWidth,c.height=R.displayHeight):(c.width=R.width,c.height=R.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=D,this.setTexture2D=G,this.setTexture2DArray=z,this.setTexture3D=N,this.setTextureCube=Y,this.rebindTextures=ot,this.setupRenderTarget=Te,this.updateRenderTargetMipmap=Be,this.updateMultisampleRenderTarget=H,this.setupDepthRenderbuffer=ke,this.setupFrameBufferTexture=fe,this.useMultisampledRTT=mt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Xy(r,e){function t(n,i=_r){let s;const a=ct.getTransfer(i);if(n===Qn)return r.UNSIGNED_BYTE;if(n===vh)return r.UNSIGNED_SHORT_4_4_4_4;if(n===Sh)return r.UNSIGNED_SHORT_5_5_5_1;if(n===lm)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===cm)return r.UNSIGNED_INT_10F_11F_11F_REV;if(n===am)return r.BYTE;if(n===om)return r.SHORT;if(n===eo)return r.UNSIGNED_SHORT;if(n===xh)return r.INT;if(n===Oi)return r.UNSIGNED_INT;if(n===Pi)return r.FLOAT;if(n===ar)return r.HALF_FLOAT;if(n===um)return r.ALPHA;if(n===hm)return r.RGB;if(n===yi)return r.RGBA;if(n===or)return r.DEPTH_COMPONENT;if(n===jr)return r.DEPTH_STENCIL;if(n===fm)return r.RED;if(n===Mh)return r.RED_INTEGER;if(n===ta)return r.RG;if(n===yh)return r.RG_INTEGER;if(n===Eh)return r.RGBA_INTEGER;if(n===tl||n===nl||n===il||n===rl)if(a===vt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===tl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===nl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===il)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===rl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===tl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===nl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===il)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===rl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===uu||n===hu||n===fu||n===du)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===uu)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===hu)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===fu)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===du)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===pu||n===mu||n===_u||n===gu||n===xu||n===vu||n===Su)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===pu||n===mu)return a===vt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===_u)return a===vt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===gu)return s.COMPRESSED_R11_EAC;if(n===xu)return s.COMPRESSED_SIGNED_R11_EAC;if(n===vu)return s.COMPRESSED_RG11_EAC;if(n===Su)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Mu||n===yu||n===Eu||n===Tu||n===bu||n===wu||n===Au||n===Ru||n===Cu||n===Pu||n===Du||n===Lu||n===Iu||n===Uu)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Mu)return a===vt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===yu)return a===vt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Eu)return a===vt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Tu)return a===vt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===bu)return a===vt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===wu)return a===vt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Au)return a===vt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ru)return a===vt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Cu)return a===vt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Pu)return a===vt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Du)return a===vt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Lu)return a===vt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Iu)return a===vt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Uu)return a===vt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Nu||n===Fu||n===Ou)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Nu)return a===vt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Fu)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ou)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Bu||n===zu||n===ku||n===Vu)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Bu)return s.COMPRESSED_RED_RGTC1_EXT;if(n===zu)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ku)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Vu)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===to?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:t}}const Yy=`
void main() {
...
}`;class $y{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new Tm(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new zi({vertexShader:Yy,fragmentShader:qy,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new si(new Dr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Ky extends sa{constructor(e,t){super();const n=this;let i=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,h=null,d=null,f=null,g=null;const _=typeof XRWebGLBinding<"u",m=new $y,p={},E=t.getContextAttributes();let b=null,M=null;const T=[],A=[],w=new ut;let L=null;const x=new Zn;x.viewport=new Ft;const S=new Zn;S.viewport=new Ft;const C=[x,S],D=new rx;let O=null,V=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let J=T[K];return J===void 0&&(J=new mc,T[K]=J),J.getTargetRaySpace()},this.getControllerGrip=function(K){let J=T[K];return J===void 0&&(J=new mc,T[K]=J),J.getGripSpace()},this.getHand=function(K){let J=T[K];return J===void 0&&(J=new mc,T[K]=J),J.getHandSpace()};function G(K){const J=A.indexOf(K.inputSource);if(J===-1)return;const fe=T[J];fe!==void 0&&(fe.update(K.inputSource,K.frame,c||a),fe.dispatchEvent({type:K.type,data:K.inputSource}))}function z(){i.removeEventListener("select",G),i.removeEventListener("selectstart",G),i.removeEventListener("selectend",G),i.removeEventListener("squeeze",G),i.removeEventListener("squeezestart",G),i.removeEventListener("squeezeend",G),i.removeEventListener("end",z),i.removeEventListener("inputsourceschange",N);for(let K=0;K<T.length;K++){const J=A[K];J!==null&&(A[K]=null,T[K].disconnect(J))}O=null,V=null,m.reset();for(const K in p)delete p[K];e.setRenderTarget(b),f=null,d=null,h=null,i=null,M=null,qe.stop(),n.isPresenting=!1,e.setPixelRatio(L),e.setSize(w.width,w.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){s=K,n.isPresenting===!0&&Ye("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){o=K,n.isPresenting===!0&&Ye("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return d!==null?d:f},this.getBinding=function(){return h===null&&_&&(h=new XRWebGLBinding(i,t)),h},this.getFrame=function(){return g},this.getSession=function(){return i},this.setSession=async function(K){if(i=K,i!==null){if(b=e.getRenderTarget(),i.addEventListener("select",G),i.addEventListener("selectstart",G),i.addEventListener("selectend",G),i.addEventListener("squeeze",G),i.addEventListener("squeezestart",G),i.addEventListener("squeezeend",G),i.addEventListener("end",z),i.addEventListener("inputsourceschange",N),E.xrCompatible!==!0&&await t.makeXRCompatible(),L=e.getPixelRatio(),e.getSize(w),_&&"createProjectionLayer"in XRWebGLBinding.prototype){let fe=null,Ce=null,Se=null;E.depth&&(Se=E.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,fe=E.stencil?jr:or,Ce=E.stencil?to:Oi);const ke={colorFormat:t.RGBA8,depthFormat:Se,scaleFactor:s};h=this.getBinding(),d=h.createProjectionLayer(ke),i.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),M=new Ui(d.textureWidth,d.textureHeight,{format:yi,type:Qn,depthTexture:new so(d.textureWidth,d.textureHeight,Ce,void 0,void 0,void 0,void 0,void 0,void 0,fe),stencilBuffer:E.stencil,colorSpace:e.outputColorSpace,samples:E.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const fe={antialias:E.antialias,alpha:!0,depth:E.depth,stencil:E.stencil,framebufferScaleFactor:s};f=new XRWebGLLayer(i,t,fe),i.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),M=new Ui(f.framebufferWidth,f.framebufferHeight,{format:yi,type:Qn,colorSpace:e.outputColorSpace,stencilBuffer:E.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await i.requestReferenceSpace(o),qe.setContext(i),qe.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function N(K){for(let J=0;J<K.removed.length;J++){const fe=K.removed[J],Ce=A.indexOf(fe);Ce>=0&&(A[Ce]=null,T[Ce].disconnect(fe))}for(let J=0;J<K.added.length;J++){const fe=K.added[J];let Ce=A.indexOf(fe);if(Ce===-1){for(let ke=0;ke<T.length;ke++)if(ke>=A.length){A.push(fe),Ce=ke;break}else if(A[ke]===null){A[ke]=fe,Ce=ke;break}if(Ce===-1)break}const Se=T[Ce];Se&&Se.connect(fe)}}const Y=new W,ee=new W;function P(K,J,fe){Y.setFromMatrixPosition(J.matrixWorld),ee.setFromMatrixPosition(fe.matrixWorld);const Ce=Y.distanceTo(ee),Se=J.projectionMatrix.elements,ke=fe.projectionMatrix.elements,ot=Se[14]/(Se[10]-1),Te=Se[14]/(Se[10]+1),Be=(Se[9]+1)/Se[5],Ke=(Se[9]-1)/Se[5],Ue=(Se[8]-1)/Se[0],H=(ke[8]+1)/ke[0],U=ot*Ue,mt=ot*H,Qe=Ce/(-Ue+H),ze=Qe*-Ue;if(J.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(ze),K.translateZ(Qe),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),Se[10]===-1)K.projectionMatrix.copy(J.projectionMatrix),K.projectionMatrixInverse.copy(J.projectionMatrixInverse);else{const Me=ot+Qe,R=Te+Qe,v=U-ze,F=mt+(Ce-ze),Z=Be*Te/R*Me,j=Ke*Te/R*Me;K.projectionMatrix.makePerspective(v,F,Z,j,Me,R),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function re(K,J){J===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(J.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(i===null)return;let J=K.near,fe=K.far;m.texture!==null&&(m.depthNear>0&&(J=m.depthNear),m.depthFar>0&&(fe=m.depthFar)),D.near=S.near=x.near=J,D.far=S.far=x.far=fe,(O!==D.near||V!==D.far)&&(i.updateRenderState({depthNear:D.near,depthFar:D.far}),O=D.near,V=D.far),D.layers.mask=K.layers.mask|6,x.layers.mask=D.layers.mask&3,S.layers.mask=D.layers.mask&5;const Ce=K.parent,Se=D.cameras;re(D,Ce);for(let ke=0;ke<Se.length;ke++)re(Se[ke],Ce);Se.length===2?P(D,x,S):D.projectionMatrix.copy(x.projectionMatrix),Le(K,D,Ce)};function Le(K,J,fe){fe===null?K.matrix.copy(J.matrixWorld):(K.matrix.copy(fe.matrixWorld),K.matrix.invert(),K.matrix.multiply(J.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(J.projectionMatrix),K.projectionMatrixInverse.copy(J.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=ia*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return D},this.getFoveation=function(){if(!(d===null&&f===null))return l},this.setFoveation=function(K){l=K,d!==null&&(d.fixedFoveation=K),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=K)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(D)},this.getCameraTexture=function(K){return p[K]};let Oe=null;function He(K,J){if(u=J.getViewerPose(c||a),g=J,u!==null){const fe=u.views;f!==null&&(e.setRenderTargetFramebuffer(M,f.framebuffer),e.setRenderTarget(M));let Ce=!1;fe.length!==D.cameras.length&&(D.cameras.length=0,Ce=!0);for(let Te=0;Te<fe.length;Te++){const Be=fe[Te];let Ke=null;if(f!==null)Ke=f.getViewport(Be);else{const H=h.getViewSubImage(d,Be);Ke=H.viewport,Te===0&&(e.setRenderTargetTextures(M,H.colorTexture,H.depthStencilTexture),e.setRenderTarget(M))}let Ue=C[Te];Ue===void 0&&(Ue=new Zn,Ue.layers.enable(Te),Ue.viewport=new Ft,C[Te]=Ue),Ue.matrix.fromArray(Be.transform.matrix),Ue.matrix.decompose(Ue.position,Ue.quaternion,Ue.scale),Ue.projectionMatrix.fromArray(Be.projectionMatrix),Ue.projectionMatrixInverse.copy(Ue.projectionMatrix).invert(),Ue.viewport.set(Ke.x,Ke.y,Ke.width,Ke.height),Te===0&&(D.matrix.copy(Ue.matrix),D.matrix.decompose(D.position,D.quaternion,D.scale)),Ce===!0&&D.cameras.push(Ue)}const Se=i.enabledFeatures;if(Se&&Se.includes("depth-sensing")&&i.depthUsage=="gpu-optimized"&&_){h=n.getBinding();const Te=h.getDepthInformation(fe[0]);Te&&Te.isValid&&Te.texture&&m.init(Te,i.renderState)}if(Se&&Se.includes("camera-access")&&_){e.state.unbindTexture(),h=n.getBinding();for(let Te=0;Te<fe.length;Te++){const Be=fe[Te].camera;if(Be){let Ke=p[Be];Ke||(Ke=new Tm,p[Be]=Ke);const Ue=h.getCameraImage(Be);Ke.sourceTexture=Ue}}}}for(let fe=0;fe<T.length;fe++){const Ce=A[fe],Se=T[fe];Ce!==null&&Se!==void 0&&Se.update(Ce,J,c||a)}Oe&&Oe(K,J),J.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:J}),g=null}const qe=new wm;qe.setAnimationLoop(He),this.setAnimationLoop=function(K){Oe=K},this.dispose=function(){}}}const Vr=new Bi,Zy=new It;function jy(r,e){function t(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,Sm(r)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function i(m,p,E,b,M){p.isMeshBasicMaterial||p.isMeshLambertMaterial?s(m,p):p.isMeshToonMaterial?(s(m,p),h(m,p)):p.isMeshPhongMaterial?(s(m,p),u(m,p)):p.isMeshStandardMaterial?(s(m,p),d(m,p),p.isMeshPhysicalMaterial&&f(m,p,M)):p.isMeshMatcapMaterial?(s(m,p),g(m,p)):p.isMeshDepthMaterial?s(m,p):p.isMeshDistanceMaterial?(s(m,p),_(m,p)):p.isMeshNormalMaterial?s(m,p):p.isLineBasicMaterial?(a(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?l(m,p,E,b):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function s(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,t(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===Bn&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,t(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===Bn&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,t(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,t(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,t(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const E=e.get(p),b=E.envMap,M=E.envMapRotation;b&&(m.envMap.value=b,Vr.copy(M),Vr.x*=-1,Vr.y*=-1,Vr.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(Vr.y*=-1,Vr.z*=-1),m.envMapRotation.value.setFromMatrix4(Zy.makeRotationFromEuler(Vr)),m.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,t(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,t(p.aoMap,m.aoMapTransform))}function a(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,E,b){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*E,m.scale.value=b*.5,p.map&&(m.map.value=p.map,t(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function u(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function h(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function d(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,t(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,t(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,E){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,t(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,t(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,t(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,t(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,t(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===Bn&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,t(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,t(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=E.texture,m.transmissionSamplerSize.value.set(E.width,E.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,t(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,t(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,t(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,t(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,t(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function _(m,p){const E=e.get(p).light;m.referencePosition.value.setFromMatrixPosition(E.matrixWorld),m.nearDistance.value=E.shadow.camera.near,m.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:i}}function Jy(r,e,t,n){let i={},s={},a=[];const o=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function l(E,b){const M=b.program;n.uniformBlockBinding(E,M)}function c(E,b){let M=i[E.id];M===void 0&&(g(E),M=u(E),i[E.id]=M,E.addEventListener("dispose",m));const T=b.program;n.updateUBOMapping(E,T);const A=e.render.frame;s[E.id]!==A&&(d(E),s[E.id]=A)}function u(E){const b=h();E.__bindingPointIndex=b;const M=r.createBuffer(),T=E.__size,A=E.usage;return r.bindBuffer(r.UNIFORM_BUFFER,M),r.bufferData(r.UNIFORM_BUFFER,T,A),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,b,M),M}function h(){for(let E=0;E<o;E++)if(a.indexOf(E)===-1)return a.push(E),E;return lt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(E){const b=i[E.id],M=E.uniforms,T=E.__cache;r.bindBuffer(r.UNIFORM_BUFFER,b);for(let A=0,w=M.length;A<w;A++){const L=Array.isArray(M[A])?M[A]:[M[A]];for(let x=0,S=L.length;x<S;x++){const C=L[x];if(f(C,A,x,T)===!0){const D=C.__offset,O=Array.isArray(C.value)?C.value:[C.value];let V=0;for(let G=0;G<O.length;G++){const z=O[G],N=_(z);typeof z=="number"||typeof z=="boolean"?(C.__data[0]=z,r.bufferSubData(r.UNIFORM_BUFFER,D+V,C.__data)):z.isMatrix3?(C.__data[0]=z.elements[0],C.__data[1]=z.elements[1],C.__data[2]=z.elements[2],C.__data[3]=0,C.__data[4]=z.elements[3],C.__data[5]=z.elements[4],C.__data[6]=z.elements[5],C.__data[7]=0,C.__data[8]=z.elements[6],C.__data[9]=z.elements[7],C.__data[10]=z.elements[8],C.__data[11]=0):(z.toArray(C.__data,V),V+=N.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,D,C.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function f(E,b,M,T){const A=E.value,w=b+"_"+M;if(T[w]===void 0)return typeof A=="number"||typeof A=="boolean"?T[w]=A:T[w]=A.clone(),!0;{const L=T[w];if(typeof A=="number"||typeof A=="boolean"){if(L!==A)return T[w]=A,!0}else if(L.equals(A)===!1)return L.copy(A),!0}return!1}function g(E){const b=E.uniforms;let M=0;const T=16;for(let w=0,L=b.length;w<L;w++){const x=Array.isArray(b[w])?b[w]:[b[w]];for(let S=0,C=x.length;S<C;S++){const D=x[S],O=Array.isArray(D.value)?D.value:[D.value];for(let V=0,G=O.length;V<G;V++){const z=O[V],N=_(z),Y=M%T,ee=Y%N.boundary,P=Y+ee;M+=ee,P!==0&&T-P<N.storage&&(M+=T-P),D.__data=new Float32Array(N.storage/Float32Array.BYTES_PER_ELEMENT),D.__offset=M,M+=N.storage}}}const A=M%T;return A>0&&(M+=T-A),E.__size=M,E.__cache={},this}function _(E){const b={boundary:0,storage:0};return typeof E=="number"||typeof E=="boolean"?(b.boundary=4,b.storage=4):E.isVector2?(b.boundary=8,b.storage=8):E.isVector3||E.isColor?(b.boundary=16,b.storage=12):E.isVector4?(b.boundary=16,b.storage=16):E.isMatrix3?(b.boundary=48,b.storage=48):E.isMatrix4?(b.boundary=64,b.storage=64):E.isTexture?Ye("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Ye("WebGLRenderer: Unsupported uniform value type.",E),b}function m(E){const b=E.target;b.removeEventListener("dispose",m);const M=a.indexOf(b.__bindingPointIndex);a.splice(M,1),r.deleteBuffer(i[b.id]),delete i[b.id],delete s[b.id]}function p(){for(const E in i)r.deleteBuffer(i[E]);a=[],i={},s={}}return{bind:l,update:c,dispose:p}}const Qy=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Ei=null;function eE(){return Ei===null&&(Ei=new k0(Qy,16,16,ta,ar),Ei.name="DFG_LUT",Ei.minFilter=gn,Ei.magFilter=gn,Ei.wrapS=Qi,Ei.wrapT=Qi,Ei.generateMipmaps=!1,Ei.needsUpdate=!0),Ei}class tE{constructor(e={}){const{canvas:t=Jg(),context:n=null,depth:i=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:d=!1,outputBufferType:f=Qn}=e;this.isWebGLRenderer=!0;let g;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=n.getContextAttributes().alpha}else g=a;const _=f,m=new Set([Eh,yh,Mh]),p=new Set([Qn,Oi,eo,to,vh,Sh]),E=new Uint32Array(4),b=new Int32Array(4);let M=null,T=null;const A=[],w=[];let L=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Ii,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const x=this;let S=!1;this._outputColorSpace=In;let C=0,D=0,O=null,V=-1,G=null;const z=new Ft,N=new Ft;let Y=null;const ee=new pt(0);let P=0,re=t.width,Le=t.height,Oe=1,He=null,qe=null;const K=new Ft(0,0,re,Le),J=new Ft(0,0,re,Le);let fe=!1;const Ce=new Ph;let Se=!1,ke=!1;const ot=new It,Te=new W,Be=new Ft,Ke={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ue=!1;function H(){return O===null?Oe:1}let U=n;function mt(y,B){return t.getContext(y,B)}try{const y={alpha:!0,depth:i,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${gh}`),t.addEventListener("webglcontextlost",Ie,!1),t.addEventListener("webglcontextrestored",ht,!1),t.addEventListener("webglcontextcreationerror",_e,!1),U===null){const B="webgl2";if(U=mt(B,y),U===null)throw mt(B)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(y){throw lt("WebGLRenderer: "+y.message),y}let Qe,ze,Me,R,v,F,Z,j,$,ve,se,be,Ee,ie,ae,ye,we,oe,Ge,I,ue,ne,he,te;function Q(){Qe=new eM(U),Qe.init(),ne=new Xy(U,Qe),ze=new XS(U,Qe,e,ne),Me=new Hy(U,Qe),ze.reversedDepthBuffer&&d&&Me.buffers.depth.setReversed(!0),R=new iM(U),v=new Ry,F=new Wy(U,Qe,Me,v,ze,ne,R),Z=new qS(x),j=new QS(x),$=new ox(U),he=new HS(U,$),ve=new tM(U,$,R,he),se=new sM(U,ve,$,R),Ge=new rM(U,ze,F),ye=new YS(v),be=new Ay(x,Z,j,Qe,ze,he,ye),Ee=new jy(x,v),ie=new Py,ae=new Fy(Qe),oe=new GS(x,Z,j,Me,se,g,l),we=new Vy(x,se,ze),te=new Jy(U,R,ze,Me),I=new WS(U,Qe,R),ue=new nM(U,Qe,R),R.programs=be.programs,x.capabilities=ze,x.extensions=Qe,x.properties=v,x.renderLists=ie,x.shadowMap=we,x.state=Me,x.info=R}Q(),_!==Qn&&(L=new oM(_,t.width,t.height,i,s));const ce=new Ky(x,U);this.xr=ce,this.getContext=function(){return U},this.getContextAttributes=function(){return U.getContextAttributes()},this.forceContextLoss=function(){const y=Qe.get("WEBGL_lose_context");y&&y.loseContext()},this.forceContextRestore=function(){const y=Qe.get("WEBGL_lose_context");y&&y.restoreContext()},this.getPixelRatio=function(){return Oe},this.setPixelRatio=function(y){y!==void 0&&(Oe=y,this.setSize(re,Le,!1))},this.getSize=function(y){return y.set(re,Le)},this.setSize=function(y,B,q=!0){if(ce.isPresenting){Ye("WebGLRenderer: Can't change size while VR device is presenting.");return}re=y,Le=B,t.width=Math.floor(y*Oe),t.height=Math.floor(B*Oe),q===!0&&(t.style.width=y+"px",t.style.height=B+"px"),L!==null&&L.setSize(t.width,t.height),this.setViewport(0,0,y,B)},this.getDrawingBufferSize=function(y){return y.set(re*Oe,Le*Oe).floor()},this.setDrawingBufferSize=function(y,B,q){re=y,Le=B,Oe=q,t.width=Math.floor(y*q),t.height=Math.floor(B*q),this.setViewport(0,0,y,B)},this.setEffects=function(y){if(_===Qn){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(y){for(let B=0;B<y.length;B++)if(y[B].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}L.setEffects(y||[])},this.getCurrentViewport=function(y){return y.copy(z)},this.getViewport=function(y){return y.copy(K)},this.setViewport=function(y,B,q,X){y.isVector4?K.set(y.x,y.y,y.z,y.w):K.set(y,B,q,X),Me.viewport(z.copy(K).multiplyScalar(Oe).round())},this.getScissor=function(y){return y.copy(J)},this.setScissor=function(y,B,q,X){y.isVector4?J.set(y.x,y.y,y.z,y.w):J.set(y,B,q,X),Me.scissor(N.copy(J).multiplyScalar(Oe).round())},this.getScissorTest=function(){return fe},this.setScissorTest=function(y){Me.setScissorTest(fe=y)},this.setOpaqueSort=function(y){He=y},this.setTransparentSort=function(y){qe=y},this.getClearColor=function(y){return y.copy(oe.getClearColor())},this.setClearColor=function(){oe.setClearColor(...arguments)},this.getClearAlpha=function(){return oe.getClearAlpha()},this.setClearAlpha=function(){oe.setClearAlpha(...arguments)},this.clear=function(y=!0,B=!0,q=!0){let X=0;if(y){let k=!1;if(O!==null){const le=O.texture.format;k=m.has(le)}if(k){const le=O.texture.type,ge=p.has(le),de=oe.getClearColor(),xe=oe.getClearAlpha(),Pe=de.r,Ve=de.g,Ne=de.b;ge?(E[0]=Pe,E[1]=Ve,E[2]=Ne,E[3]=xe,U.clearBufferuiv(U.COLOR,0,E)):(b[0]=Pe,b[1]=Ve,b[2]=Ne,b[3]=xe,U.clearBufferiv(U.COLOR,0,b))}else X|=U.COLOR_BUFFER_BIT}B&&(X|=U.DEPTH_BUFFER_BIT),q&&(X|=U.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),U.clear(X)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Ie,!1),t.removeEventListener("webglcontextrestored",ht,!1),t.removeEventListener("webglcontextcreationerror",_e,!1),oe.dispose(),ie.dispose(),ae.dispose(),v.dispose(),Z.dispose(),j.dispose(),se.dispose(),he.dispose(),te.dispose(),be.dispose(),ce.dispose(),ce.removeEventListener("sessionstart",Bt),ce.removeEventListener("sessionend",tt),gt.stop()};function Ie(y){y.preventDefault(),wf("WebGLRenderer: Context Lost."),S=!0}function ht(){wf("WebGLRenderer: Context Restored."),S=!1;const y=R.autoReset,B=we.enabled,q=we.autoUpdate,X=we.needsUpdate,k=we.type;Q(),R.autoReset=y,we.enabled=B,we.autoUpdate=q,we.needsUpdate=X,we.type=k}function _e(y){lt("WebGLRenderer: A WebGL context could not be created. Reason: ",y.statusMessage)}function Re(y){const B=y.target;B.removeEventListener("dispose",Re),Ze(B)}function Ze(y){pe(y),v.remove(y)}function pe(y){const B=v.get(y).programs;B!==void 0&&(B.forEach(function(q){be.releaseProgram(q)}),y.isShaderMaterial&&be.releaseShaderCache(y))}this.renderBufferDirect=function(y,B,q,X,k,le){B===null&&(B=Ke);const ge=k.isMesh&&k.matrixWorld.determinant()<0,de=Yt(y,B,q,X,k);Me.setMaterial(X,ge);let xe=q.index,Pe=1;if(X.wireframe===!0){if(xe=ve.getWireframeAttribute(q),xe===void 0)return;Pe=2}const Ve=q.drawRange,Ne=q.attributes.position;let nt=Ve.start*Pe,Mt=(Ve.start+Ve.count)*Pe;le!==null&&(nt=Math.max(nt,le.start*Pe),Mt=Math.min(Mt,(le.start+le.count)*Pe)),xe!==null?(nt=Math.max(nt,0),Mt=Math.min(Mt,xe.count)):Ne!=null&&(nt=Math.max(nt,0),Mt=Math.min(Mt,Ne.count));const Ut=Mt-nt;if(Ut<0||Ut===1/0)return;he.setup(k,X,de,q,xe);let Nt,Et=I;if(xe!==null&&(Nt=$.get(xe),Et=ue,Et.setIndex(Nt)),k.isMesh)X.wireframe===!0?(Me.setLineWidth(X.wireframeLinewidth*H()),Et.setMode(U.LINES)):Et.setMode(U.TRIANGLES);else if(k.isLine){let Fe=X.linewidth;Fe===void 0&&(Fe=1),Me.setLineWidth(Fe*H()),k.isLineSegments?Et.setMode(U.LINES):k.isLineLoop?Et.setMode(U.LINE_LOOP):Et.setMode(U.LINE_STRIP)}else k.isPoints?Et.setMode(U.POINTS):k.isSprite&&Et.setMode(U.TRIANGLES);if(k.isBatchedMesh)if(k._multiDrawInstances!==null)io("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Et.renderMultiDrawInstances(k._multiDrawStarts,k._multiDrawCounts,k._multiDrawCount,k._multiDrawInstances);else if(Qe.get("WEBGL_multi_draw"))Et.renderMultiDraw(k._multiDrawStarts,k._multiDrawCounts,k._multiDrawCount);else{const Fe=k._multiDrawStarts,xt=k._multiDrawCounts,dt=k._multiDrawCount,Vn=xe?$.get(xe).bytesPerElement:1,ds=v.get(X).currentProgram.getUniforms();for(let Gn=0;Gn<dt;Gn++)ds.setValue(U,"_gl_DrawID",Gn),Et.render(Fe[Gn]/Vn,xt[Gn])}else if(k.isInstancedMesh)Et.renderInstances(nt,Ut,k.count);else if(q.isInstancedBufferGeometry){const Fe=q._maxInstanceCount!==void 0?q._maxInstanceCount:1/0,xt=Math.min(q.instanceCount,Fe);Et.renderInstances(nt,Ut,xt)}else Et.render(nt,Ut)};function We(y,B,q){y.transparent===!0&&y.side===Zi&&y.forceSinglePass===!1?(y.side=Bn,y.needsUpdate=!0,St(y,B,q),y.side=Pr,y.needsUpdate=!0,St(y,B,q),y.side=Zi):St(y,B,q)}this.compile=function(y,B,q=null){q===null&&(q=y),T=ae.get(q),T.init(B),w.push(T),q.traverseVisible(function(k){k.isLight&&k.layers.test(B.layers)&&(T.pushLight(k),k.castShadow&&T.pushShadow(k))}),y!==q&&y.traverseVisible(function(k){k.isLight&&k.layers.test(B.layers)&&(T.pushLight(k),k.castShadow&&T.pushShadow(k))}),T.setupLights();const X=new Set;return y.traverse(function(k){if(!(k.isMesh||k.isPoints||k.isLine||k.isSprite))return;const le=k.material;if(le)if(Array.isArray(le))for(let ge=0;ge<le.length;ge++){const de=le[ge];We(de,q,k),X.add(de)}else We(le,q,k),X.add(le)}),T=w.pop(),X},this.compileAsync=function(y,B,q=null){const X=this.compile(y,B,q);return new Promise(k=>{function le(){if(X.forEach(function(ge){v.get(ge).currentProgram.isReady()&&X.delete(ge)}),X.size===0){k(y);return}setTimeout(le,10)}Qe.get("KHR_parallel_shader_compile")!==null?le():setTimeout(le,10)})};let De=null;function Xe(y){De&&De(y)}function Bt(){gt.stop()}function tt(){gt.start()}const gt=new wm;gt.setAnimationLoop(Xe),typeof self<"u"&&gt.setContext(self),this.setAnimationLoop=function(y){De=y,ce.setAnimationLoop(y),y===null?gt.stop():gt.start()},ce.addEventListener("sessionstart",Bt),ce.addEventListener("sessionend",tt),this.render=function(y,B){if(B!==void 0&&B.isCamera!==!0){lt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(S===!0)return;const q=ce.enabled===!0&&ce.isPresenting===!0,X=L!==null&&(O===null||q)&&L.begin(x,O);if(y.matrixWorldAutoUpdate===!0&&y.updateMatrixWorld(),B.parent===null&&B.matrixWorldAutoUpdate===!0&&B.updateMatrixWorld(),ce.enabled===!0&&ce.isPresenting===!0&&(L===null||L.isCompositing()===!1)&&(ce.cameraAutoUpdate===!0&&ce.updateCamera(B),B=ce.getCamera()),y.isScene===!0&&y.onBeforeRender(x,y,B,O),T=ae.get(y,w.length),T.init(B),w.push(T),ot.multiplyMatrices(B.projectionMatrix,B.matrixWorldInverse),Ce.setFromProjectionMatrix(ot,Di,B.reversedDepth),ke=this.localClippingEnabled,Se=ye.init(this.clippingPlanes,ke),M=ie.get(y,A.length),M.init(),A.push(M),ce.enabled===!0&&ce.isPresenting===!0){const ge=x.xr.getDepthSensingMesh();ge!==null&&Vt(ge,B,-1/0,x.sortObjects)}Vt(y,B,0,x.sortObjects),M.finish(),x.sortObjects===!0&&M.sort(He,qe),Ue=ce.enabled===!1||ce.isPresenting===!1||ce.hasDepthSensing()===!1,Ue&&oe.addToRenderList(M,y),this.info.render.frame++,Se===!0&&ye.beginShadows();const k=T.state.shadowsArray;if(we.render(k,y,B),Se===!0&&ye.endShadows(),this.info.autoReset===!0&&this.info.reset(),(X&&L.hasRenderPass())===!1){const ge=M.opaque,de=M.transmissive;if(T.setupLights(),B.isArrayCamera){const xe=B.cameras;if(de.length>0)for(let Pe=0,Ve=xe.length;Pe<Ve;Pe++){const Ne=xe[Pe];yt(ge,de,y,Ne)}Ue&&oe.render(y);for(let Pe=0,Ve=xe.length;Pe<Ve;Pe++){const Ne=xe[Pe];Rt(M,y,Ne,Ne.viewport)}}else de.length>0&&yt(ge,de,y,B),Ue&&oe.render(y),Rt(M,y,B)}O!==null&&D===0&&(F.updateMultisampleRenderTarget(O),F.updateRenderTargetMipmap(O)),X&&L.end(x),y.isScene===!0&&y.onAfterRender(x,y,B),he.resetDefaultState(),V=-1,G=null,w.pop(),w.length>0?(T=w[w.length-1],Se===!0&&ye.setGlobalState(x.clippingPlanes,T.state.camera)):T=null,A.pop(),A.length>0?M=A[A.length-1]:M=null};function Vt(y,B,q,X){if(y.visible===!1)return;if(y.layers.test(B.layers)){if(y.isGroup)q=y.renderOrder;else if(y.isLOD)y.autoUpdate===!0&&y.update(B);else if(y.isLight)T.pushLight(y),y.castShadow&&T.pushShadow(y);else if(y.isSprite){if(!y.frustumCulled||Ce.intersectsSprite(y)){X&&Be.setFromMatrixPosition(y.matrixWorld).applyMatrix4(ot);const ge=se.update(y),de=y.material;de.visible&&M.push(y,ge,de,q,Be.z,null)}}else if((y.isMesh||y.isLine||y.isPoints)&&(!y.frustumCulled||Ce.intersectsObject(y))){const ge=se.update(y),de=y.material;if(X&&(y.boundingSphere!==void 0?(y.boundingSphere===null&&y.computeBoundingSphere(),Be.copy(y.boundingSphere.center)):(ge.boundingSphere===null&&ge.computeBoundingSphere(),Be.copy(ge.boundingSphere.center)),Be.applyMatrix4(y.matrixWorld).applyMatrix4(ot)),Array.isArray(de)){const xe=ge.groups;for(let Pe=0,Ve=xe.length;Pe<Ve;Pe++){const Ne=xe[Pe],nt=de[Ne.materialIndex];nt&&nt.visible&&M.push(y,ge,nt,q,Be.z,Ne)}}else de.visible&&M.push(y,ge,de,q,Be.z,null)}}const le=y.children;for(let ge=0,de=le.length;ge<de;ge++)Vt(le[ge],B,q,X)}function Rt(y,B,q,X){const{opaque:k,transmissive:le,transparent:ge}=y;T.setupLightsView(q),Se===!0&&ye.setGlobalState(x.clippingPlanes,q),X&&Me.viewport(z.copy(X)),k.length>0&&ft(k,B,q),le.length>0&&ft(le,B,q),ge.length>0&&ft(ge,B,q),Me.buffers.depth.setTest(!0),Me.buffers.depth.setMask(!0),Me.buffers.color.setMask(!0),Me.setPolygonOffset(!1)}function yt(y,B,q,X){if((q.isScene===!0?q.overrideMaterial:null)!==null)return;if(T.state.transmissionRenderTarget[X.id]===void 0){const nt=Qe.has("EXT_color_buffer_half_float")||Qe.has("EXT_color_buffer_float");T.state.transmissionRenderTarget[X.id]=new Ui(1,1,{generateMipmaps:!0,type:nt?ar:Qn,minFilter:Zr,samples:ze.samples,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ct.workingColorSpace})}const le=T.state.transmissionRenderTarget[X.id],ge=X.viewport||z;le.setSize(ge.z*x.transmissionResolutionScale,ge.w*x.transmissionResolutionScale);const de=x.getRenderTarget(),xe=x.getActiveCubeFace(),Pe=x.getActiveMipmapLevel();x.setRenderTarget(le),x.getClearColor(ee),P=x.getClearAlpha(),P<1&&x.setClearColor(16777215,.5),x.clear(),Ue&&oe.render(q);const Ve=x.toneMapping;x.toneMapping=Ii;const Ne=X.viewport;if(X.viewport!==void 0&&(X.viewport=void 0),T.setupLightsView(X),Se===!0&&ye.setGlobalState(x.clippingPlanes,X),ft(y,q,X),F.updateMultisampleRenderTarget(le),F.updateRenderTargetMipmap(le),Qe.has("WEBGL_multisampled_render_to_texture")===!1){let nt=!1;for(let Mt=0,Ut=B.length;Mt<Ut;Mt++){const Nt=B[Mt],{object:Et,geometry:Fe,material:xt,group:dt}=Nt;if(xt.side===Zi&&Et.layers.test(X.layers)){const Vn=xt.side;xt.side=Bn,xt.needsUpdate=!0,Cn(Et,q,X,Fe,xt,dt),xt.side=Vn,xt.needsUpdate=!0,nt=!0}}nt===!0&&(F.updateMultisampleRenderTarget(le),F.updateRenderTargetMipmap(le))}x.setRenderTarget(de,xe,Pe),x.setClearColor(ee,P),Ne!==void 0&&(X.viewport=Ne),x.toneMapping=Ve}function ft(y,B,q){const X=B.isScene===!0?B.overrideMaterial:null;for(let k=0,le=y.length;k<le;k++){const ge=y[k],{object:de,geometry:xe,group:Pe}=ge;let Ve=ge.material;Ve.allowOverride===!0&&X!==null&&(Ve=X),de.layers.test(q.layers)&&Cn(de,B,q,xe,Ve,Pe)}}function Cn(y,B,q,X,k,le){y.onBeforeRender(x,B,q,X,k,le),y.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,y.matrixWorld),y.normalMatrix.getNormalMatrix(y.modelViewMatrix),k.onBeforeRender(x,B,q,X,y,le),k.transparent===!0&&k.side===Zi&&k.forceSinglePass===!1?(k.side=Bn,k.needsUpdate=!0,x.renderBufferDirect(q,B,X,k,y,le),k.side=Pr,k.needsUpdate=!0,x.renderBufferDirect(q,B,X,k,y,le),k.side=Zi):x.renderBufferDirect(q,B,X,k,y,le),y.onAfterRender(x,B,q,X,k,le)}function St(y,B,q){B.isScene!==!0&&(B=Ke);const X=v.get(y),k=T.state.lights,le=T.state.shadowsArray,ge=k.state.version,de=be.getParameters(y,k.state,le,B,q),xe=be.getProgramCacheKey(de);let Pe=X.programs;X.environment=y.isMeshStandardMaterial?B.environment:null,X.fog=B.fog,X.envMap=(y.isMeshStandardMaterial?j:Z).get(y.envMap||X.environment),X.envMapRotation=X.environment!==null&&y.envMap===null?B.environmentRotation:y.envMapRotation,Pe===void 0&&(y.addEventListener("dispose",Re),Pe=new Map,X.programs=Pe);let Ve=Pe.get(xe);if(Ve!==void 0){if(X.currentProgram===Ve&&X.lightsStateVersion===ge)return kn(y,de),Ve}else de.uniforms=be.getUniforms(y),y.onBeforeCompile(de,x),Ve=be.acquireProgram(de,xe),Pe.set(xe,Ve),X.uniforms=de.uniforms;const Ne=X.uniforms;return(!y.isShaderMaterial&&!y.isRawShaderMaterial||y.clipping===!0)&&(Ne.clippingPlanes=ye.uniform),kn(y,de),X.needsLights=Jt(y),X.lightsStateVersion=ge,X.needsLights&&(Ne.ambientLightColor.value=k.state.ambient,Ne.lightProbe.value=k.state.probe,Ne.directionalLights.value=k.state.directional,Ne.directionalLightShadows.value=k.state.directionalShadow,Ne.spotLights.value=k.state.spot,Ne.spotLightShadows.value=k.state.spotShadow,Ne.rectAreaLights.value=k.state.rectArea,Ne.ltc_1.value=k.state.rectAreaLTC1,Ne.ltc_2.value=k.state.rectAreaLTC2,Ne.pointLights.value=k.state.point,Ne.pointLightShadows.value=k.state.pointShadow,Ne.hemisphereLights.value=k.state.hemi,Ne.directionalShadowMap.value=k.state.directionalShadowMap,Ne.directionalShadowMatrix.value=k.state.directionalShadowMatrix,Ne.spotShadowMap.value=k.state.spotShadowMap,Ne.spotLightMatrix.value=k.state.spotLightMatrix,Ne.spotLightMap.value=k.state.spotLightMap,Ne.pointShadowMap.value=k.state.pointShadowMap,Ne.pointShadowMatrix.value=k.state.pointShadowMatrix),X.currentProgram=Ve,X.uniformsList=null,Ve}function un(y){if(y.uniformsList===null){const B=y.currentProgram.getUniforms();y.uniformsList=sl.seqWithValue(B.seq,y.uniforms)}return y.uniformsList}function kn(y,B){const q=v.get(y);q.outputColorSpace=B.outputColorSpace,q.batching=B.batching,q.batchingColor=B.batchingColor,q.instancing=B.instancing,q.instancingColor=B.instancingColor,q.instancingMorph=B.instancingMorph,q.skinning=B.skinning,q.morphTargets=B.morphTargets,q.morphNormals=B.morphNormals,q.morphColors=B.morphColors,q.morphTargetsCount=B.morphTargetsCount,q.numClippingPlanes=B.numClippingPlanes,q.numIntersection=B.numClipIntersection,q.vertexAlphas=B.vertexAlphas,q.vertexTangents=B.vertexTangents,q.toneMapping=B.toneMapping}function Yt(y,B,q,X,k){B.isScene!==!0&&(B=Ke),F.resetTextureUnits();const le=B.fog,ge=X.isMeshStandardMaterial?B.environment:null,de=O===null?x.outputColorSpace:O.isXRRenderTarget===!0?O.texture.colorSpace:na,xe=(X.isMeshStandardMaterial?j:Z).get(X.envMap||ge),Pe=X.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,Ve=!!q.attributes.tangent&&(!!X.normalMap||X.anisotropy>0),Ne=!!q.morphAttributes.position,nt=!!q.morphAttributes.normal,Mt=!!q.morphAttributes.color;let Ut=Ii;X.toneMapped&&(O===null||O.isXRRenderTarget===!0)&&(Ut=x.toneMapping);const Nt=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,Et=Nt!==void 0?Nt.length:0,Fe=v.get(X),xt=T.state.lights;if(Se===!0&&(ke===!0||y!==G)){const vn=y===G&&X.id===V;ye.setState(X,y,vn)}let dt=!1;X.version===Fe.__version?(Fe.needsLights&&Fe.lightsStateVersion!==xt.state.version||Fe.outputColorSpace!==de||k.isBatchedMesh&&Fe.batching===!1||!k.isBatchedMesh&&Fe.batching===!0||k.isBatchedMesh&&Fe.batchingColor===!0&&k.colorTexture===null||k.isBatchedMesh&&Fe.batchingColor===!1&&k.colorTexture!==null||k.isInstancedMesh&&Fe.instancing===!1||!k.isInstancedMesh&&Fe.instancing===!0||k.isSkinnedMesh&&Fe.skinning===!1||!k.isSkinnedMesh&&Fe.skinning===!0||k.isInstancedMesh&&Fe.instancingColor===!0&&k.instanceColor===null||k.isInstancedMesh&&Fe.instancingColor===!1&&k.instanceColor!==null||k.isInstancedMesh&&Fe.instancingMorph===!0&&k.morphTexture===null||k.isInstancedMesh&&Fe.instancingMorph===!1&&k.morphTexture!==null||Fe.envMap!==xe||X.fog===!0&&Fe.fog!==le||Fe.numClippingPlanes!==void 0&&(Fe.numClippingPlanes!==ye.numPlanes||Fe.numIntersection!==ye.numIntersection)||Fe.vertexAlphas!==Pe||Fe.vertexTangents!==Ve||Fe.morphTargets!==Ne||Fe.morphNormals!==nt||Fe.morphColors!==Mt||Fe.toneMapping!==Ut||Fe.morphTargetsCount!==Et)&&(dt=!0):(dt=!0,Fe.__version=X.version);let Vn=Fe.currentProgram;dt===!0&&(Vn=St(X,B,k));let ds=!1,Gn=!1,ca=!1;const wt=Vn.getUniforms(),Pn=Fe.uniforms;if(Me.useProgram(Vn.program)&&(ds=!0,Gn=!0,ca=!0),X.id!==V&&(V=X.id,Gn=!0),ds||G!==y){Me.buffers.depth.getReversed()&&y.reversedDepth!==!0&&(y._reversedDepth=!0,y.updateProjectionMatrix()),wt.setValue(U,"projectionMatrix",y.projectionMatrix),wt.setValue(U,"viewMatrix",y.matrixWorldInverse);const Dn=wt.map.cameraPosition;Dn!==void 0&&Dn.setValue(U,Te.setFromMatrixPosition(y.matrixWorld)),ze.logarithmicDepthBuffer&&wt.setValue(U,"logDepthBufFC",2/(Math.log(y.far+1)/Math.LN2)),(X.isMeshPhongMaterial||X.isMeshToonMaterial||X.isMeshLambertMaterial||X.isMeshBasicMaterial||X.isMeshStandardMaterial||X.isShaderMaterial)&&wt.setValue(U,"isOrthographic",y.isOrthographicCamera===!0),G!==y&&(G=y,Gn=!0,ca=!0)}if(Fe.needsLights&&(xt.state.directionalShadowMap.length>0&&wt.setValue(U,"directionalShadowMap",xt.state.directionalShadowMap,F),xt.state.spotShadowMap.length>0&&wt.setValue(U,"spotShadowMap",xt.state.spotShadowMap,F),xt.state.pointShadowMap.length>0&&wt.setValue(U,"pointShadowMap",xt.state.pointShadowMap,F)),k.isSkinnedMesh){wt.setOptional(U,k,"bindMatrix"),wt.setOptional(U,k,"bindMatrixInverse");const vn=k.skeleton;vn&&(vn.boneTexture===null&&vn.computeBoneTexture(),wt.setValue(U,"boneTexture",vn.boneTexture,F))}k.isBatchedMesh&&(wt.setOptional(U,k,"batchingTexture"),wt.setValue(U,"batchingTexture",k._matricesTexture,F),wt.setOptional(U,k,"batchingIdTexture"),wt.setValue(U,"batchingIdTexture",k._indirectTexture,F),wt.setOptional(U,k,"batchingColorTexture"),k._colorsTexture!==null&&wt.setValue(U,"batchingColorTexture",k._colorsTexture,F));const ai=q.morphAttributes;if((ai.position!==void 0||ai.normal!==void 0||ai.color!==void 0)&&Ge.update(k,q,Vn),(Gn||Fe.receiveShadow!==k.receiveShadow)&&(Fe.receiveShadow=k.receiveShadow,wt.setValue(U,"receiveShadow",k.receiveShadow)),X.isMeshGouraudMaterial&&X.envMap!==null&&(Pn.envMap.value=xe,Pn.flipEnvMap.value=xe.isCubeTexture&&xe.isRenderTargetTexture===!1?-1:1),X.isMeshStandardMaterial&&X.envMap===null&&B.environment!==null&&(Pn.envMapIntensity.value=B.environmentIntensity),Pn.dfgLUT!==void 0&&(Pn.dfgLUT.value=eE()),Gn&&(wt.setValue(U,"toneMappingExposure",x.toneMappingExposure),Fe.needsLights&&qt(Pn,ca),le&&X.fog===!0&&Ee.refreshFogUniforms(Pn,le),Ee.refreshMaterialUniforms(Pn,X,Oe,Le,T.state.transmissionRenderTarget[y.id]),sl.upload(U,un(Fe),Pn,F)),X.isShaderMaterial&&X.uniformsNeedUpdate===!0&&(sl.upload(U,un(Fe),Pn,F),X.uniformsNeedUpdate=!1),X.isSpriteMaterial&&wt.setValue(U,"center",k.center),wt.setValue(U,"modelViewMatrix",k.modelViewMatrix),wt.setValue(U,"normalMatrix",k.normalMatrix),wt.setValue(U,"modelMatrix",k.matrixWorld),X.isShaderMaterial||X.isRawShaderMaterial){const vn=X.uniformsGroups;for(let Dn=0,Ll=vn.length;Dn<Ll;Dn++){const Ir=vn[Dn];te.update(Ir,Vn),te.bind(Ir,Vn)}}return Vn}function qt(y,B){y.ambientLightColor.needsUpdate=B,y.lightProbe.needsUpdate=B,y.directionalLights.needsUpdate=B,y.directionalLightShadows.needsUpdate=B,y.pointLights.needsUpdate=B,y.pointLightShadows.needsUpdate=B,y.spotLights.needsUpdate=B,y.spotLightShadows.needsUpdate=B,y.rectAreaLights.needsUpdate=B,y.hemisphereLights.needsUpdate=B}function Jt(y){return y.isMeshLambertMaterial||y.isMeshToonMaterial||y.isMeshPhongMaterial||y.isMeshStandardMaterial||y.isShadowMaterial||y.isShaderMaterial&&y.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return D},this.getRenderTarget=function(){return O},this.setRenderTargetTextures=function(y,B,q){const X=v.get(y);X.__autoAllocateDepthBuffer=y.resolveDepthBuffer===!1,X.__autoAllocateDepthBuffer===!1&&(X.__useRenderToTexture=!1),v.get(y.texture).__webglTexture=B,v.get(y.depthTexture).__webglTexture=X.__autoAllocateDepthBuffer?void 0:q,X.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(y,B){const q=v.get(y);q.__webglFramebuffer=B,q.__useDefaultFramebuffer=B===void 0};const ki=U.createFramebuffer();this.setRenderTarget=function(y,B=0,q=0){O=y,C=B,D=q;let X=null,k=!1,le=!1;if(y){const de=v.get(y);if(de.__useDefaultFramebuffer!==void 0){Me.bindFramebuffer(U.FRAMEBUFFER,de.__webglFramebuffer),z.copy(y.viewport),N.copy(y.scissor),Y=y.scissorTest,Me.viewport(z),Me.scissor(N),Me.setScissorTest(Y),V=-1;return}else if(de.__webglFramebuffer===void 0)F.setupRenderTarget(y);else if(de.__hasExternalTextures)F.rebindTextures(y,v.get(y.texture).__webglTexture,v.get(y.depthTexture).__webglTexture);else if(y.depthBuffer){const Ve=y.depthTexture;if(de.__boundDepthTexture!==Ve){if(Ve!==null&&v.has(Ve)&&(y.width!==Ve.image.width||y.height!==Ve.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");F.setupDepthRenderbuffer(y)}}const xe=y.texture;(xe.isData3DTexture||xe.isDataArrayTexture||xe.isCompressedArrayTexture)&&(le=!0);const Pe=v.get(y).__webglFramebuffer;y.isWebGLCubeRenderTarget?(Array.isArray(Pe[B])?X=Pe[B][q]:X=Pe[B],k=!0):y.samples>0&&F.useMultisampledRTT(y)===!1?X=v.get(y).__webglMultisampledFramebuffer:Array.isArray(Pe)?X=Pe[q]:X=Pe,z.copy(y.viewport),N.copy(y.scissor),Y=y.scissorTest}else z.copy(K).multiplyScalar(Oe).floor(),N.copy(J).multiplyScalar(Oe).floor(),Y=fe;if(q!==0&&(X=ki),Me.bindFramebuffer(U.FRAMEBUFFER,X)&&Me.drawBuffers(y,X),Me.viewport(z),Me.scissor(N),Me.setScissorTest(Y),k){const de=v.get(y.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_CUBE_MAP_POSITIVE_X+B,de.__webglTexture,q)}else if(le){const de=B;for(let xe=0;xe<y.textures.length;xe++){const Pe=v.get(y.textures[xe]);U.framebufferTextureLayer(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0+xe,Pe.__webglTexture,q,de)}}else if(y!==null&&q!==0){const de=v.get(y.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,de.__webglTexture,q)}V=-1},this.readRenderTargetPixels=function(y,B,q,X,k,le,ge,de=0){if(!(y&&y.isWebGLRenderTarget)){lt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let xe=v.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&ge!==void 0&&(xe=xe[ge]),xe){Me.bindFramebuffer(U.FRAMEBUFFER,xe);try{const Pe=y.textures[de],Ve=Pe.format,Ne=Pe.type;if(!ze.textureFormatReadable(Ve)){lt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ze.textureTypeReadable(Ne)){lt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}B>=0&&B<=y.width-X&&q>=0&&q<=y.height-k&&(y.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+de),U.readPixels(B,q,X,k,ne.convert(Ve),ne.convert(Ne),le))}finally{const Pe=O!==null?v.get(O).__webglFramebuffer:null;Me.bindFramebuffer(U.FRAMEBUFFER,Pe)}}},this.readRenderTargetPixelsAsync=async function(y,B,q,X,k,le,ge,de=0){if(!(y&&y.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let xe=v.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&ge!==void 0&&(xe=xe[ge]),xe)if(B>=0&&B<=y.width-X&&q>=0&&q<=y.height-k){Me.bindFramebuffer(U.FRAMEBUFFER,xe);const Pe=y.textures[de],Ve=Pe.format,Ne=Pe.type;if(!ze.textureFormatReadable(Ve))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ze.textureTypeReadable(Ne))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const nt=U.createBuffer();U.bindBuffer(U.PIXEL_PACK_BUFFER,nt),U.bufferData(U.PIXEL_PACK_BUFFER,le.byteLength,U.STREAM_READ),y.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+de),U.readPixels(B,q,X,k,ne.convert(Ve),ne.convert(Ne),0);const Mt=O!==null?v.get(O).__webglFramebuffer:null;Me.bindFramebuffer(U.FRAMEBUFFER,Mt);const Ut=U.fenceSync(U.SYNC_GPU_COMMANDS_COMPLETE,0);return U.flush(),await Qg(U,Ut,4),U.bindBuffer(U.PIXEL_PACK_BUFFER,nt),U.getBufferSubData(U.PIXEL_PACK_BUFFER,0,le),U.deleteBuffer(nt),U.deleteSync(Ut),le}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(y,B=null,q=0){const X=Math.pow(2,-q),k=Math.floor(y.image.width*X),le=Math.floor(y.image.height*X),ge=B!==null?B.x:0,de=B!==null?B.y:0;F.setTexture2D(y,0),U.copyTexSubImage2D(U.TEXTURE_2D,q,0,0,ge,de,k,le),Me.unbindTexture()};const fs=U.createFramebuffer(),Qt=U.createFramebuffer();this.copyTextureToTexture=function(y,B,q=null,X=null,k=0,le=null){le===null&&(k!==0?(io("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),le=k,k=0):le=0);let ge,de,xe,Pe,Ve,Ne,nt,Mt,Ut;const Nt=y.isCompressedTexture?y.mipmaps[le]:y.image;if(q!==null)ge=q.max.x-q.min.x,de=q.max.y-q.min.y,xe=q.isBox3?q.max.z-q.min.z:1,Pe=q.min.x,Ve=q.min.y,Ne=q.isBox3?q.min.z:0;else{const ai=Math.pow(2,-k);ge=Math.floor(Nt.width*ai),de=Math.floor(Nt.height*ai),y.isDataArrayTexture?xe=Nt.depth:y.isData3DTexture?xe=Math.floor(Nt.depth*ai):xe=1,Pe=0,Ve=0,Ne=0}X!==null?(nt=X.x,Mt=X.y,Ut=X.z):(nt=0,Mt=0,Ut=0);const Et=ne.convert(B.format),Fe=ne.convert(B.type);let xt;B.isData3DTexture?(F.setTexture3D(B,0),xt=U.TEXTURE_3D):B.isDataArrayTexture||B.isCompressedArrayTexture?(F.setTexture2DArray(B,0),xt=U.TEXTURE_2D_ARRAY):(F.setTexture2D(B,0),xt=U.TEXTURE_2D),U.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,B.flipY),U.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,B.premultiplyAlpha),U.pixelStorei(U.UNPACK_ALIGNMENT,B.unpackAlignment);const dt=U.getParameter(U.UNPACK_ROW_LENGTH),Vn=U.getParameter(U.UNPACK_IMAGE_HEIGHT),ds=U.getParameter(U.UNPACK_SKIP_PIXELS),Gn=U.getParameter(U.UNPACK_SKIP_ROWS),ca=U.getParameter(U.UNPACK_SKIP_IMAGES);U.pixelStorei(U.UNPACK_ROW_LENGTH,Nt.width),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,Nt.height),U.pixelStorei(U.UNPACK_SKIP_PIXELS,Pe),U.pixelStorei(U.UNPACK_SKIP_ROWS,Ve),U.pixelStorei(U.UNPACK_SKIP_IMAGES,Ne);const wt=y.isDataArrayTexture||y.isData3DTexture,Pn=B.isDataArrayTexture||B.isData3DTexture;if(y.isDepthTexture){const ai=v.get(y),vn=v.get(B),Dn=v.get(ai.__renderTarget),Ll=v.get(vn.__renderTarget);Me.bindFramebuffer(U.READ_FRAMEBUFFER,Dn.__webglFramebuffer),Me.bindFramebuffer(U.DRAW_FRAMEBUFFER,Ll.__webglFramebuffer);for(let Ir=0;Ir<xe;Ir++)wt&&(U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,v.get(y).__webglTexture,k,Ne+Ir),U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,v.get(B).__webglTexture,le,Ut+Ir)),U.blitFramebuffer(Pe,Ve,ge,de,nt,Mt,ge,de,U.DEPTH_BUFFER_BIT,U.NEAREST);Me.bindFramebuffer(U.READ_FRAMEBUFFER,null),Me.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else if(k!==0||y.isRenderTargetTexture||v.has(y)){const ai=v.get(y),vn=v.get(B);Me.bindFramebuffer(U.READ_FRAMEBUFFER,fs),Me.bindFramebuffer(U.DRAW_FRAMEBUFFER,Qt);for(let Dn=0;Dn<xe;Dn++)wt?U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,ai.__webglTexture,k,Ne+Dn):U.framebufferTexture2D(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,ai.__webglTexture,k),Pn?U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,vn.__webglTexture,le,Ut+Dn):U.framebufferTexture2D(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,vn.__webglTexture,le),k!==0?U.blitFramebuffer(Pe,Ve,ge,de,nt,Mt,ge,de,U.COLOR_BUFFER_BIT,U.NEAREST):Pn?U.copyTexSubImage3D(xt,le,nt,Mt,Ut+Dn,Pe,Ve,ge,de):U.copyTexSubImage2D(xt,le,nt,Mt,Pe,Ve,ge,de);Me.bindFramebuffer(U.READ_FRAMEBUFFER,null),Me.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else Pn?y.isDataTexture||y.isData3DTexture?U.texSubImage3D(xt,le,nt,Mt,Ut,ge,de,xe,Et,Fe,Nt.data):B.isCompressedArrayTexture?U.compressedTexSubImage3D(xt,le,nt,Mt,Ut,ge,de,xe,Et,Nt.data):U.texSubImage3D(xt,le,nt,Mt,Ut,ge,de,xe,Et,Fe,Nt):y.isDataTexture?U.texSubImage2D(U.TEXTURE_2D,le,nt,Mt,ge,de,Et,Fe,Nt.data):y.isCompressedTexture?U.compressedTexSubImage2D(U.TEXTURE_2D,le,nt,Mt,Nt.width,Nt.height,Et,Nt.data):U.texSubImage2D(U.TEXTURE_2D,le,nt,Mt,ge,de,Et,Fe,Nt);U.pixelStorei(U.UNPACK_ROW_LENGTH,dt),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,Vn),U.pixelStorei(U.UNPACK_SKIP_PIXELS,ds),U.pixelStorei(U.UNPACK_SKIP_ROWS,Gn),U.pixelStorei(U.UNPACK_SKIP_IMAGES,ca),le===0&&B.generateMipmaps&&U.generateMipmap(xt),Me.unbindTexture()},this.initRenderTarget=function(y){v.get(y).__webglFramebuffer===void 0&&F.setupRenderTarget(y)},this.initTexture=function(y){y.isCubeTexture?F.setTextureCube(y,0):y.isData3DTexture?F.setTexture3D(y,0):y.isDataArrayTexture||y.isCompressedArrayTexture?F.setTexture2DArray(y,0):F.setTexture2D(y,0),Me.unbindTexture()},this.resetState=function(){C=0,D=0,O=null,Me.reset(),he.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Di}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=ct._getDrawingBufferColorSpace(e),t.unpackColorSpace=ct._getUnpackColorSpace()}}const vd="/portfolio2/assets/rust-BQoPGTt7.jpg",Sd="/portfolio2/assets/golang-CzP5kEUb.jpg",nE="/portfolio2/assets/python-DX_iAbtG.jpg",iE="/portfolio2/assets/cuda-DlQBI4ZY.jpg",Dl=[{image:vd,title:"Project One",sub:"Rust · Systems programming at its finest",link:"https://github.com/H-strangeone/project-one"},{image:vd,title:"Serv fdpk",sub:"This project is an experiment in rethinking how data moves and how search works on the internet or more specifically, building our own free, decentralized internet from first principles.",link:"https://github.com/H-strangeone/serv-fdpk.git"},{image:Sd,title:"CLI based TODO",sub:"Go · Scalable backend service",link:"https://github.com/H-strangeone/todo.git"},{image:Sd,title:"Project Four",sub:"Go · REST API with auth",link:"https://github.com/H-strangeone/project-four"},{image:nE,title:"SBOM - TM",sub:`SBOM-TM is a GitHub Action–based security tool that automatically scans your repository for software supply-chain risks using a Software Bill of Materials (SBOM).
It provides Dependabot-style security visibility, but for everything in your project — not just dependency updates.`,link:"https://github.com/H-strangeone/SBOM-TM.git"},{image:iE,title:"Gpu programming for metaheuristics",sub:"even i dont know what i am doing with this",link:""}],al=Dl.length,Dm=Math.PI*2/al,Ml=3.6,yl=2.2;let qi,ji,Si,Jr,ui=0,bc=!1,Qr=null;const rE=new Q0,El=new sx,ol=new ut(-9999,-9999);let ci,Yn;const sE=Dl.map(()=>({scaleCurrent:1,scaleTarget:1})),Md=new oa,yd=new W,Ed=new W,Td=new W,bd=new pt;function aE(){const r=document.getElementById("three-container");if(!r)return;cE(r),qi=new z0,ji=new Zn(60,r.clientWidth/r.clientHeight,.1,100),ji.position.set(0,.5,0),Si=new tE({antialias:!0,alpha:!0}),Si.outputColorSpace=In,Si.setSize(r.clientWidth,r.clientHeight),Si.setPixelRatio(Math.min(window.devicePixelRatio,2)),r.insertBefore(Si.domElement,r.firstChild),qi.add(new ix(16777215,.4));const e=new Yf(16777215,1);e.position.set(2,8,3),qi.add(e);const t=new Yf(13687016,.25);t.position.set(-5,2,1),qi.add(t);const n=new tx(16777215,3.5,24,Math.PI/5.5,.55,2);n.position.set(0,6,-1),n.target.position.set(0,0,-5),qi.add(n),qi.add(n.target),Jr=new Xt,qi.add(Jr);const i=new Dr(Ml,yl),s=new Dr(Ml+.1,yl+.1);Dl.forEach((l,c)=>{const u=new Xt;u.rotation.y=c*Dm,Jr.add(u);const h=new Ra;h.position.z=-5,h.userData={index:c,link:l.link},u.add(h);const d=new ro({color:2236962,transparent:!0,opacity:.45}),f=new si(s,d);f.position.z=-.015,h.add(f),h.userData.borderMesh=f;const g=rE.load(l.image);g.colorSpace=In;const _=new q0({map:g,roughness:.45,metalness:.04,transparent:!0,opacity:1}),m=new si(i,_);m.userData.parentGroup=h,m.userData.isImage=!0,h.add(m),h.userData.imageMesh=m,oE(u,h,g)}),lE(r);const a=document.getElementById("arrow-left"),o=document.getElementById("arrow-right");a&&a.addEventListener("click",()=>va(ui-1)),o&&o.addEventListener("click",()=>va(ui+1)),window.addEventListener("keydown",l=>{l.key==="ArrowLeft"&&va(ui-1),l.key==="ArrowRight"&&va(ui+1)}),r.addEventListener("mousemove",l=>{const c=r.getBoundingClientRect();ol.x=(l.clientX-c.left)/c.width*2-1,ol.y=-((l.clientY-c.top)/c.height)*2+1}),r.addEventListener("mouseleave",()=>ol.set(-9999,-9999)),r.addEventListener("click",()=>{Qr&&Qr.userData.index===ui&&window.open(Qr.userData.link,"_blank")}),r.addEventListener("touchend",l=>{const c=l.changedTouches[0],u=r.getBoundingClientRect(),h=new ut((c.clientX-u.left)/u.width*2-1,-((c.clientY-u.top)/u.height)*2+1);El.setFromCamera(h,ji);const d=[];Jr.children.forEach(_=>{_.children[0]?.userData.imageMesh&&d.push(_.children[0].userData.imageMesh)});const f=El.intersectObjects(d,!1);if(!f.length)return;const g=f[0].object.userData.parentGroup;g&&(g.userData.index===ui?window.open(g.userData.link,"_blank"):va(g.userData.index))}),window.addEventListener("resize",()=>{ji.aspect=r.clientWidth/r.clientHeight,ji.updateProjectionMatrix(),Si.setSize(r.clientWidth,r.clientHeight)}),Lm(ui,!1),Si.setAnimationLoop(uE)}function oE(r,e,t){const n=new Dr(Ml,yl),i=new ro({map:t,transparent:!0,opacity:.09,depthWrite:!1}),s=new si(n,i);s.position.z=-5,s.position.y=-2.3200000000000003,s.rotation.x=Math.PI,s.renderOrder=-1,r.add(s),e.userData.reflMesh=s;const a=new Dr(Ml,yl*.7),o=document.createElement("canvas");o.width=4,o.height=64;const l=o.getContext("2d"),c=l.createLinearGradient(0,0,0,64);c.addColorStop(0,"rgba(5,5,5,0)"),c.addColorStop(.5,"rgba(5,5,5,0.6)"),c.addColorStop(1,"rgba(5,5,5,1)"),l.fillStyle=c,l.fillRect(0,0,4,64);const u=new W0(o),h=new si(a,new ro({map:u,transparent:!0,depthWrite:!1}));h.position.z=-5,h.position.y=-2.3100000000000005,h.rotation.x=Math.PI,h.renderOrder=0,r.add(h)}function lE(r){const e=document.createElement("div");e.style.cssText=`
  ...
  `,Yn=document.createElement("div"),Yn.style.cssText=`
    ...
    transition: opacity 0.35s ease, transform 0.35s ease;
  `,Yn.style.whiteSpace="pre-line",r.appendChild(ci),r.appendChild(Yn)}function Lm(r,e=!0){const t=Dl[r];!ci||!Yn||(e?(ci.style.opacity="0",ci.style.transform="translateY(-8px)",Yn.style.opacity="0",Yn.style.transform="translateY(8px)",setTimeout(()=>{ci.textContent=t.title,Yn.textContent=t.sub,ci.style.opacity="1",ci.style.transform="translateY(0)",Yn.style.opacity="1",Yn.style.transform="translateY(0)"},320)):(ci.textContent=t.title,Yn.textContent=t.sub,ci.style.opacity="1",ci.style.transform="translateY(0)",Yn.style.opacity="1",Yn.style.transform="translateY(0)"))}function va(r){bc||(bc=!0,ui=(r%al+al)%al,Lm(ui,!0),sn.to(Jr.rotation,{y:-ui*Dm,duration:1.1,ease:"power3.inOut",onComplete:()=>{bc=!1}}))}function uE(){if(!Si||!qi||!ji)return;const r=[];Jr.children.forEach(t=>{const n=t.children[0];n?.userData.imageMesh&&r.push(n.userData.imageMesh)}),El.setFromCamera(ol,ji);const e=El.intersectObjects(r,!1);Qr=e.length>0?e[0].object.userData.parentGroup??null:null,Si.domElement&&(Si.domElement.style.cursor=Qr&&Qr.userData.index===ui?"pointer":"default"),Jr.children.forEach((t,n)=>{const i=t.children[0];if(!i)return;const s=sE[n],a=n===ui,o=Qr===i;s.scaleTarget=o&&a?1.05:1,s.scaleCurrent=bo.lerp(s.scaleCurrent,s.scaleTarget,.09),i.scale.setScalar(s.scaleCurrent),i.getWorldQuaternion(Md),i.getWorldPosition(yd),Ed.set(0,0,1).applyQuaternion(Md),Td.copy(ji.position).sub(yd).normalize();const l=Ed.dot(Td),c=bo.lerp(.18,1,bo.smoothstep(l,.3,.85));if(i.userData.imageMesh&&i.userData.imageMesh.material.color.setScalar(c),i.userData.borderMesh){const u=a?.85:.28,h=i.userData.borderMesh.material;h.opacity=bo.lerp(h.opacity,u,.07),bd.set(a?4868677:1315860),h.color.lerp(bd,.07)}}),Si.render(qi,ji)}function hE(){}function fE(){}window.startThree=hE;window.stopThree=fE;sn.registerPlugin($e);document.addEventListener("DOMContentLoaded",()=>{aE();const r=window.matchMedia("(max-width: 768px)").matches;let e=window.innerHeight;function t(){const C=window.innerHeight;Math.abs(C-e)>100&&(e=C,$e.refresh(!0)),document.documentElement.style.setProperty("--vh",`${e}px`)}t(),window.addEventListener("resize",t);const n=new vg({duration:r?.6:1.2,smooth:!r,smoothTouch:!0,easing:C=>Math.min(1,1.001-Math.pow(2,-10*C))});function i(C){n.raf(C),requestAnimationFrame(i)}requestAnimationFrame(i),n.on("scroll",$e.update);const s=document.querySelector(".window-container"),a=document.querySelector(".sky-container"),o=document.querySelector(".hero-header"),l=document.querySelector(".hero-copy"),c=document.getElementById("panel-intro"),u=document.getElementById("panel-education"),h=document.getElementById("panel-resume");let d=0;function f(){d=a.offsetHeight-e}f(),window.addEventListener("resize",f),sn.set(l,{yPercent:100,opacity:0}),sn.set(s,{scale:1}),sn.set([c,u,h],{opacity:0,y:60,pointerEvents:"none"});const g=C=>Math.min(1,Math.max(0,C)),_=(C,D,O)=>g((C-D)/(O-D)),m=C=>1-Math.pow(1-C,3),p=C=>C*C;function E(C,D,O,V,G,z){let N,Y;if(D<O)N=0,Y=60;else if(D<V){const ee=m(_(D,O,V));N=ee,Y=60*(1-ee)}else if(D<G)N=1,Y=0;else if(D<z){const ee=p(_(D,G,z));N=1-ee,Y=-40*ee}else N=0,Y=-40;sn.set(C,{opacity:N,y:Y,pointerEvents:N>.05?"auto":"none"})}$e.create({trigger:".hero",start:"top top",end:`+=${window.innerHeight*(r?3.5:5.5)}px`,pin:!0,pinSpacing:!0,scrub:1.5,onUpdate:C=>{const D=C.progress;let O,V;D<.17?(O=sn.utils.mapRange(0,.17,1,12,D),V=1):D<.21?(O=12,V=1):(O=12,V=sn.utils.mapRange(.21,.28,1,0,D)),sn.set(s,{scale:O,opacity:V});let G;D<.21?G=1:G=sn.utils.mapRange(.21,.28,1,0,D),sn.set(o,{scale:O,z:D*500,opacity:G}),sn.set(a,{y:-d*D*(r?1.05:1.3)}),E(c,D,.24,.31,.35,.4),E(u,D,.4,.47,.52,.57),E(h,D,.57,.64,.68,.73);let z,N;if(D<.73)z=100,N=0;else if(D>=1)z=0,N=1;else{const P=(D-.73)/.27;z=100*(1-P),N=P}sn.set(l,{yPercent:z,opacity:N});const Y=document.querySelector(".hero-outro");let ee=0;D>.76&&(ee=sn.utils.mapRange(.76,.9,0,1,D)),sn.set(Y,{opacity:ee})}});let b,M=e;window.addEventListener("resize",()=>{Math.abs(window.innerHeight-M)>100&&(clearTimeout(b),b=setTimeout(()=>{M=window.innerHeight,$e.refresh(!0)},150))});const T=document.querySelector(".contact-modal"),A=document.querySelector(".contact-trigger"),w=document.querySelector(".contact-close"),L=document.querySelector(".contact-backdrop");A.addEventListener("click",()=>{T.classList.add("active"),T.setAttribute("aria-hidden","false")});function x(){T.classList.remove("active"),T.setAttribute("aria-hidden","true")}w.addEventListener("click",x),L.addEventListener("click",x),document.addEventListener("keydown",C=>{C.key==="Escape"&&x()});const S=r?300:200;sn.fromTo(".three-outro",{opacity:0},{opacity:1,ease:"none",scrollTrigger:{trigger:".three-outro",start:`top bottom+=${S}`,end:"top top",scrub:!0}}),$e.create({trigger:".three-outro",start:"top bottom",end:"bottom top",onEnter:()=>window.startThree(),onLeave:()=>window.stopThree(),onEnterBack:()=>window.startThree(),onLeaveBack:()=>window.stopThree()})});const wc=document.querySelectorAll(".github-inner > *");if(wc.length){const r=new IntersectionObserver(e=>{e.forEach(t=>{if(t.isIntersecting){const n=[...wc].indexOf(t.target);setTimeout(()=>{t.target.classList.add("is-visible")},n*120),r.unobserve(t.target)}})},{threshold:.1});wc.forEach(e=>r.observe(e))}$e.addEventListener("refresh",()=>{const r=document.querySelector(".pin-spacer");r&&(r.style.background="var(--dark)")});document.querySelectorAll(".pin-spacer").forEach(r=>{r.style.background="transparent"});
